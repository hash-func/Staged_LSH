...
port (
    ...
    bit_element           :out  STD_LOGIC_VECTOR(63 downto 0)
);
...
architecture behave of table_serch_control_s_axi is
    ...
    constant ADDR_QUERY_DATA_0              : INTEGER := 16#18#;
    constant ADDR_QUERY_DATA_1              : INTEGER := 16#1c#;
    constant ADDR_QUERY_CTRL                : INTEGER := 16#20#;
    constant ADDR_FP_DB_DATA_0              : INTEGER := 16#24#;
    constant ADDR_FP_DB_DATA_1              : INTEGER := 16#28#;
    constant ADDR_FP_DB_CTRL                : INTEGER := 16#2c#;
    constant ADDR_HASH_TABLE_DATA_0         : INTEGER := 16#30#;
    constant ADDR_HASH_TABLE_DATA_1         : INTEGER := 16#34#;
    constant ADDR_HASH_TABLE_CTRL           : INTEGER := 16#38#;
    constant ADDR_HASH_TABLE_POINTER_DATA_0 : INTEGER := 16#3c#;
    constant ADDR_HASH_TABLE_POINTER_DATA_1 : INTEGER := 16#40#;
    constant ADDR_HASH_TABLE_POINTER_CTRL   : INTEGER := 16#44#;
    constant ADDR_BIT_ELEMENT_DATA_0        : INTEGER := 16#48#;
    constant ADDR_BIT_ELEMENT_DATA_1        : INTEGER := 16#4c#;
    constant ADDR_BIT_ELEMENT_CTRL          : INTEGER := 16#50#;
    ...
    signal int_bit_element     : UNSIGNED(63 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_BIT_ELEMENT_DATA_0 =>
                        rdata_data <= RESIZE(int_bit_element(31 downto 0), 32);
                    when ADDR_BIT_ELEMENT_DATA_1 =>
                        rdata_data <= RESIZE(int_bit_element(63 downto 32), 32);
                    when others =>
                        NULL;
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    bit_element          <= STD_LOGIC_VECTOR(int_bit_element);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_BIT_ELEMENT_DATA_0) then
                    int_bit_element(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_bit_element(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_BIT_ELEMENT_DATA_1) then
                    int_bit_element(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_bit_element(63 downto 32));
                end if;
            end if;
        end if;
    end process;
