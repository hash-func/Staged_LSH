...
// wrapc file define:
#define AUTOTB_TVIN_bit_element "../tv/cdatafile/c.table_serch.autotvin_bit_element.dat"
#define AUTOTB_TVOUT_bit_element "../tv/cdatafile/c.table_serch.autotvout_bit_element.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_bit_element "../tv/rtldatafile/rtl.table_serch.autotvout_bit_element.dat"
...
string get_depth_list () {
  ...
  total_list << "{bit_element " << bit_element_depth << "}\n";
...
extern "C" int table_serch_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
...
//bit_element
aesl_fh.touch(AUTOTB_TVIN_bit_element);
aesl_fh.touch(AUTOTB_TVOUT_bit_element);
...
unsigned __xlx_offset_byte_param_bit_element = 0;
...
__xlx_tmp_lv.range(511,448) = ((long long*)__xlx_apatb_param_hash_table_pointer)[j*8+7];
  ...
  __xlx_offset_byte_param_bit_element = 4*64;
  if (__xlx_apatb_param_bit_element) {
    for (int j = 0  - 0, e = 1 - 0; j != e; ++j) {
sc_bv<512> __xlx_tmp_lv;
__xlx_tmp_lv.range(63,0) = ((long long*)__xlx_apatb_param_bit_element)[j*8+0];
__xlx_tmp_lv.range(127,64) = ((long long*)__xlx_apatb_param_bit_element)[j*8+1];
__xlx_tmp_lv.range(191,128) = ((long long*)__xlx_apatb_param_bit_element)[j*8+2];
__xlx_tmp_lv.range(255,192) = ((long long*)__xlx_apatb_param_bit_element)[j*8+3];
__xlx_tmp_lv.range(319,256) = ((long long*)__xlx_apatb_param_bit_element)[j*8+4];
__xlx_tmp_lv.range(383,320) = ((long long*)__xlx_apatb_param_bit_element)[j*8+5];
__xlx_tmp_lv.range(447,384) = ((long long*)__xlx_apatb_param_bit_element)[j*8+6];
__xlx_tmp_lv.range(511,448) = ((long long*)__xlx_apatb_param_bit_element)[j*8+7];
...
// print bit_element Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_bit_element, __xlx_sprintf_buffer.data());
  {
    sc_bv<64> __xlx_tmp_lv = __xlx_offset_byte_param_bit_element;

    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_bit_element, __xlx_sprintf_buffer.data()); 
  }
  tcl_file.set_num(1, &tcl_file.bit_element_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_bit_element, __xlx_sprintf_buffer.data());
}
CodeState = CALL_C_DUT;
int ap_return = table_serch_hw_stub_wrapper(__xlx_apatb_param_query, __xlx_apatb_param_FP_DB, __xlx_apatb_param_hash_table, __xlx_apatb_param_hash_table_pointer, __xlx_apatb_param_bit_element);
