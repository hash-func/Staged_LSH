...
module table_serch_seisa_func22 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [12:0] haming_dis_1_fu_591_p2;
...
wire    reg_1_hd_cal32_fu_286_ap_ready;
wire   [31:0] reg_1_hd_cal32_fu_286_subfp1;
wire   [31:0] reg_1_hd_cal32_fu_286_subfp2;
wire   [5:0] reg_1_hd_cal32_fu_286_ap_return;
wire    reg_2_hd_cal32_fu_292_ap_ready;
wire   [31:0] reg_2_hd_cal32_fu_292_subfp1;
wire   [31:0] reg_2_hd_cal32_fu_292_subfp2;
wire   [5:0] reg_2_hd_cal32_fu_292_ap_return;
wire    reg_3_hd_cal32_fu_298_ap_ready;
wire   [31:0] reg_3_hd_cal32_fu_298_subfp1;
wire   [31:0] reg_3_hd_cal32_fu_298_subfp2;
wire   [5:0] reg_3_hd_cal32_fu_298_ap_return;
reg   [511:0] ap_phi_mux_empty_102_phi_fu_265_p4;
wire   [511:0] ap_phi_reg_pp0_iter2_empty_102_reg_262;
wire   [511:0] zext_ln1201_2_fu_444_p1;
reg   [511:0] ap_phi_mux_empty_103_phi_fu_274_p4;
wire   [511:0] ap_phi_reg_pp0_iter2_empty_103_reg_271;
wire   [511:0] zext_ln1201_1_fu_439_p1;
wire  signed [63:0] sext_ln1233_1_fu_338_p1;
wire  signed [63:0] sext_ln1201_fu_358_p1;
wire  signed [63:0] sext_ln1201_1_fu_404_p1;
...
wire   [6:0] zext_ln1199_1_fu_549_p1;
wire   [6:0] add_ln1207_fu_561_p2;
wire   [6:0] zext_ln1199_2_fu_553_p1;
wire   [6:0] zext_ln1199_3_fu_557_p1;
wire   [6:0] add_ln1207_1_fu_571_p2;
wire   [7:0] zext_ln1207_1_fu_577_p1;
wire   [7:0] zext_ln1207_fu_567_p1;
wire   [7:0] add_ln1207_2_fu_581_p2;
wire   [12:0] zext_ln1207_2_fu_587_p1;
reg   [144:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
wire    ap_ce_reg;
...
table_serch_hd_cal32 reg_1_hd_cal32_fu_286(
    .ap_ready(reg_1_hd_cal32_fu_286_ap_ready),
    .subfp1(reg_1_hd_cal32_fu_286_subfp1),
    .subfp2(reg_1_hd_cal32_fu_286_subfp2),
    .ap_return(reg_1_hd_cal32_fu_286_ap_return)
);

table_serch_hd_cal32 reg_2_hd_cal32_fu_292(
    .ap_ready(reg_2_hd_cal32_fu_292_ap_ready),
    .subfp1(reg_2_hd_cal32_fu_292_subfp1),
    .subfp2(reg_2_hd_cal32_fu_292_subfp2),
    .ap_return(reg_2_hd_cal32_fu_292_ap_return)
);

table_serch_hd_cal32 reg_3_hd_cal32_fu_298(
    .ap_ready(reg_3_hd_cal32_fu_298_ap_ready),
    .subfp1(reg_3_hd_cal32_fu_298_subfp1),
    .subfp2(reg_3_hd_cal32_fu_298_subfp2),
    .ap_return(reg_3_hd_cal32_fu_298_ap_return)
);
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state143)) begin
        ...
        haming_dis_reg_226 <= haming_dis_1_fu_591_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state143)) begin
        ...
        indvar_i_i_reg_215 <= add_ln1201_1_fu_417_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state143)) begin
        ...
        shiftreg3_i_i_reg_250 <= {{ap_phi_mux_empty_103_phi_fu_274_p4[511:128]}};
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state143)) begin
        ...
        shiftreg_i_i_reg_238 <= {{ap_phi_mux_empty_102_phi_fu_265_p4[511:128]}};
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln1230_fu_304_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
        table_aximm1_0_addr_reg_622 <= sext_ln1233_1_fu_338_p1;
        trunc_ln12_reg_628 <= {{query_dout[63:6]}};
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state72)) begin
        trunc_ln11_reg_639 <= {{m_axi_table_aximm1_0_RDATA[31:7]}};
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state73)) begin
        trunc_ln1201_1_reg_645 <= {{add_ln1201_fu_389_p2[63:6]}};
    end
end
...
always @ (*) begin
    if ((icmp_ln1201_reg_666_pp0_iter1_reg == 1'd0)) begin
        if ((icmp_ln1206_reg_670_pp0_iter1_reg == 1'd0)) begin
            ap_phi_mux_empty_102_phi_fu_265_p4 = zext_ln1201_2_fu_444_p1;
        end else if ((icmp_ln1206_reg_670_pp0_iter1_reg == 1'd1)) begin
            ap_phi_mux_empty_102_phi_fu_265_p4 = query_plram0_0_addr_read_reg_674;
        end else begin
            ap_phi_mux_empty_102_phi_fu_265_p4 = ap_phi_reg_pp0_iter2_empty_102_reg_262;
        end
    end else begin
        ap_phi_mux_empty_102_phi_fu_265_p4 = ap_phi_reg_pp0_iter2_empty_102_reg_262;
    end
...
always @ (*) begin
    if ((icmp_ln1201_reg_666_pp0_iter1_reg == 1'd0)) begin
        if ((icmp_ln1206_reg_670_pp0_iter1_reg == 1'd0)) begin
            ap_phi_mux_empty_103_phi_fu_274_p4 = zext_ln1201_1_fu_439_p1;
        end else if ((icmp_ln1206_reg_670_pp0_iter1_reg == 1'd1)) begin
            ap_phi_mux_empty_103_phi_fu_274_p4 = DB_aximm0_0_addr_read_reg_679;
        end else begin
            ap_phi_mux_empty_103_phi_fu_274_p4 = ap_phi_reg_pp0_iter2_empty_103_reg_271;
        end
    end else begin
        ap_phi_mux_empty_103_phi_fu_274_p4 = ap_phi_reg_pp0_iter2_empty_103_reg_271;
    end
...
assign add_ln1201_1_fu_417_p2 = (indvar_i_i_reg_215 + 6'd1);

assign add_ln1201_fu_389_p2 = (FP_DB_1_reg_613 + zext_ln1201_fu_385_p1);

assign add_ln1207_1_fu_571_p2 = (zext_ln1199_2_fu_553_p1 + zext_ln1199_3_fu_557_p1);

assign add_ln1207_2_fu_581_p2 = (zext_ln1207_1_fu_577_p1 + zext_ln1207_fu_567_p1);

assign add_ln1207_fu_561_p2 = (zext_ln1199_fu_545_p1 + zext_ln1199_1_fu_549_p1);
...
assign ap_phi_reg_pp0_iter2_empty_102_reg_262 = 'bx;

assign ap_phi_reg_pp0_iter2_empty_103_reg_271 = 'bx;
...
assign haming_dis_1_fu_591_p2 = (haming_dis_reg_226 + zext_ln1207_2_fu_587_p1);
...
assign m_axi_DB_aximm0_0_ARADDR = sext_ln1201_1_fu_404_p1;
...
assign reg_1_hd_cal32_fu_286_subfp1 = {{ap_phi_mux_empty_102_phi_fu_265_p4[63:32]}};

assign reg_1_hd_cal32_fu_286_subfp2 = {{ap_phi_mux_empty_103_phi_fu_274_p4[63:32]}};

assign reg_2_hd_cal32_fu_292_subfp1 = {{ap_phi_mux_empty_102_phi_fu_265_p4[95:64]}};

assign reg_2_hd_cal32_fu_292_subfp2 = {{ap_phi_mux_empty_103_phi_fu_274_p4[95:64]}};

assign reg_3_hd_cal32_fu_298_subfp1 = {{ap_phi_mux_empty_102_phi_fu_265_p4[127:96]}};

assign reg_3_hd_cal32_fu_298_subfp2 = {{ap_phi_mux_empty_103_phi_fu_274_p4[127:96]}};

assign reg_hd_cal32_fu_280_subfp1 = ap_phi_mux_empty_102_phi_fu_265_p4[31:0];

assign reg_hd_cal32_fu_280_subfp2 = ap_phi_mux_empty_103_phi_fu_274_p4[31:0];

assign sext_ln1201_1_fu_404_p1 = $signed(trunc_ln1201_1_reg_645);

assign sext_ln1201_fu_358_p1 = $signed(trunc_ln12_reg_628);

assign sext_ln1233_1_fu_338_p1 = $signed(trunc_ln_fu_328_p4);

assign sext_ln1233_fu_318_p1 = $signed(shl_ln_fu_310_p3);

assign shl_ln9_fu_378_p3 = {{trunc_ln11_reg_639}, {9'd0}};
...
assign zext_ln1199_1_fu_549_p1 = reg_1_hd_cal32_fu_286_ap_return;

assign zext_ln1199_2_fu_553_p1 = reg_2_hd_cal32_fu_292_ap_return;

assign zext_ln1199_3_fu_557_p1 = reg_3_hd_cal32_fu_298_ap_return;

assign zext_ln1199_fu_545_p1 = reg_hd_cal32_fu_280_ap_return;

assign zext_ln1201_1_fu_439_p1 = shiftreg3_i_i_reg_250;

assign zext_ln1201_2_fu_444_p1 = shiftreg_i_i_reg_238;

assign zext_ln1201_fu_385_p1 = shl_ln9_fu_378_p3;

assign zext_ln1207_1_fu_577_p1 = add_ln1207_1_fu_571_p2;

assign zext_ln1207_2_fu_587_p1 = add_ln1207_2_fu_581_p2;

assign zext_ln1207_fu_567_p1 = add_ln1207_fu_561_p2;

assign zext_ln1226_fu_414_p1 = trunc_ln11_reg_639;
...
endmodule //table_serch_seisa_func22
