...
proc create_hier_cell_reset { parentCell nameHier } {
  ...
  # Create instance: psr_aclk2_SLR0, and set properties
  set psr_aclk2_SLR0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 psr_aclk2_SLR0 ]
  set_property -dict [ list \
   CONFIG.SLR_ASSIGNMENTS {SLR0} \
 ] $psr_aclk2_SLR0
  ...
  # Create instance: psr_aclk2_SLR2, and set properties
  set psr_aclk2_SLR2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 psr_aclk2_SLR2 ]
  set_property -dict [ list \
   CONFIG.SLR_ASSIGNMENTS {SLR2} \
 ] $psr_aclk2_SLR2
  ...
  connect_bd_net -net aclk1_1 [get_bd_pins aclk1] [get_bd_pins psr_aclk1_SLR0/slowest_sync_clk] [get_bd_pins psr_aclk1_SLR1/slowest_sync_clk] [get_bd_pins psr_aclk1_SLR2/slowest_sync_clk]
  connect_bd_net -net aclk2_1 [get_bd_pins aclk2] [get_bd_pins psr_aclk2_SLR0/slowest_sync_clk] [get_bd_pins psr_aclk2_SLR1/slowest_sync_clk] [get_bd_pins psr_aclk2_SLR2/slowest_sync_clk]
  ...
  connect_bd_net -net aresetn_1 [get_bd_pins aresetn] [get_bd_pins psr_aclk1_SLR0/ext_reset_in] [get_bd_pins psr_aclk1_SLR1/ext_reset_in] [get_bd_pins psr_aclk1_SLR2/ext_reset_in] [get_bd_pins psr_aclk2_SLR0/ext_reset_in] [get_bd_pins psr_aclk2_SLR1/ext_reset_in] [get_bd_pins psr_aclk2_SLR2/ext_reset_in] [get_bd_pins psr_aclk_SLR0/ext_reset_in] [get_bd_pins psr_aclk_SLR1/ext_reset_in] [get_bd_pins psr_aclk_SLR2/ext_reset_in]
  connect_bd_net -net psr_aclk2_SLR1_interconnect_aresetn [get_bd_pins interconnect_aresetn3] [get_bd_pins psr_aclk2_SLR1/interconnect_aresetn]
...
proc create_hier_cell_memory { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net interconnect_PLRAM_MEM00_M00_AXI [get_bd_intf_pins S_AXI3] [get_bd_intf_pins vip_PLRAM_MEM00/S_AXI]
  connect_bd_intf_net -intf_net interconnect_PLRAM_MEM01_M00_AXI [get_bd_intf_pins S_AXI4] [get_bd_intf_pins vip_PLRAM_MEM01/S_AXI]
  connect_bd_intf_net -intf_net interconnect_PLRAM_MEM02_M00_AXI [get_bd_intf_pins S_AXI5] [get_bd_intf_pins vip_PLRAM_MEM02/S_AXI]
  ...
  # Create port connections
  connect_bd_net -net aclk1_1 [get_bd_pins aclk1] [get_bd_pins ddr4_mem00_ctrl_cc/s_axi_aclk] [get_bd_pins ddr4_mem01_ctrl_cc/s_axi_aclk] [get_bd_pins ddr4_mem02_ctrl_cc/s_axi_aclk] [get_bd_pins interconnect_ddrmem_ctrl/aclk] [get_bd_pins psr_ctrl_interconnect/slowest_sync_clk] [get_bd_pins vip_ctrl_DDR4_MEM00/aclk] [get_bd_pins vip_ctrl_DDR4_MEM01/aclk] [get_bd_pins vip_ctrl_DDR4_MEM02/aclk]
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins plram_mem00/s_axi_aclk] [get_bd_pins plram_mem01/s_axi_aclk] [get_bd_pins plram_mem02/s_axi_aclk] [get_bd_pins vip_PLRAM_MEM00/aclk] [get_bd_pins vip_PLRAM_MEM01/aclk] [get_bd_pins vip_PLRAM_MEM02/aclk]
  connect_bd_net -net aresetn_1 [get_bd_pins aresetn3] [get_bd_pins psr_ctrl_interconnect/ext_reset_in]
  ...
  connect_bd_net -net psr_ctrl_interconnect_interconnect_aresetn [get_bd_pins ddr4_mem00_ctrl_cc/s_axi_aresetn] [get_bd_pins ddr4_mem01_ctrl_cc/s_axi_aresetn] [get_bd_pins ddr4_mem02_ctrl_cc/s_axi_aresetn] [get_bd_pins interconnect_ddrmem_ctrl/aresetn] [get_bd_pins psr_ctrl_interconnect/interconnect_aresetn] [get_bd_pins vip_ctrl_DDR4_MEM00/aresetn] [get_bd_pins vip_ctrl_DDR4_MEM01/aresetn] [get_bd_pins vip_ctrl_DDR4_MEM02/aresetn]
...
proc create_hier_cell_interconnect { parentCell nameHier } {
  ...
  # Create instance: rs_m00_axi_mem00, and set properties
  set rs_m00_axi_mem00 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_register_slice:2.1 rs_m00_axi_mem00 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net interconnect_PLRAM_MEM00_M00_AXI [get_bd_intf_pins M00_AXI3] [get_bd_intf_pins interconnect_plram_mem00/M00_AXI]
  connect_bd_intf_net -intf_net interconnect_PLRAM_MEM01_M00_AXI [get_bd_intf_pins M00_AXI4] [get_bd_intf_pins interconnect_plram_mem01/M00_AXI]
  connect_bd_intf_net -intf_net interconnect_PLRAM_MEM02_M00_AXI [get_bd_intf_pins M00_AXI5] [get_bd_intf_pins interconnect_plram_mem02/M00_AXI]
  ...
  connect_bd_intf_net -intf_net interconnect_S02_AXI_M00_AXI [get_bd_intf_pins interconnect_ddr4_mem01/S00_AXI] [get_bd_intf_pins interconnect_s02_axi/M00_AXI]
  connect_bd_intf_net -intf_net interconnect_S02_AXI_M01_AXI [get_bd_intf_pins interconnect_plram_mem01/S00_AXI] [get_bd_intf_pins interconnect_s02_axi/M01_AXI]
  connect_bd_intf_net -intf_net interconnect_S03_AXI_M00_AXI [get_bd_intf_pins interconnect_ddr4_mem02/S00_AXI] [get_bd_intf_pins interconnect_s03_axi/M00_AXI]
  connect_bd_intf_net -intf_net interconnect_S03_AXI_M01_AXI [get_bd_intf_pins interconnect_plram_mem02/S00_AXI] [get_bd_intf_pins interconnect_s03_axi/M01_AXI]
  connect_bd_intf_net -intf_net rs_M00_AXI_MEM00_M_AXI [get_bd_intf_pins M00_AXI6] [get_bd_intf_pins rs_m00_axi_mem00/M_AXI]
  connect_bd_intf_net -intf_net vip_M00_AXI_M_AXI [get_bd_intf_pins rs_m00_axi_mem00/S_AXI] [get_bd_intf_pins vip_m00_axi/M_AXI]
  ...
  # Create port connections
  connect_bd_net -net aclk2_1 [get_bd_pins aclk2] [get_bd_pins interconnect_m00_axi_mem00/aclk] [get_bd_pins rs_m00_axi_mem00/aclk] [get_bd_pins vip_m00_axi/aclk]
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins interconnect_ddr4_mem00/aclk1] [get_bd_pins interconnect_ddr4_mem01/aclk1] [get_bd_pins interconnect_ddr4_mem02/aclk1] [get_bd_pins interconnect_m00_axi_mem00/aclk1] [get_bd_pins interconnect_plram_mem00/aclk] [get_bd_pins interconnect_plram_mem01/aclk] [get_bd_pins interconnect_plram_mem02/aclk] [get_bd_pins interconnect_s00_axi/aclk] [get_bd_pins interconnect_s02_axi/aclk] [get_bd_pins interconnect_s03_axi/aclk] [get_bd_pins vip_s00_axi/aclk] [get_bd_pins vip_s01_axi/aclk] [get_bd_pins vip_s02_axi/aclk] [get_bd_pins vip_s03_axi/aclk]
  ...
  connect_bd_net -net psr_aclk2_SLR1_interconnect_aresetn [get_bd_pins aresetn6] [get_bd_pins interconnect_m00_axi_mem00/aresetn] [get_bd_pins rs_m00_axi_mem00/aresetn] [get_bd_pins vip_m00_axi/aresetn]
  ...
  connect_bd_net -net psr_aclk_SLR1_interconnect_aresetn [get_bd_pins aresetn1] [get_bd_pins interconnect_plram_mem01/aresetn] [get_bd_pins interconnect_s02_axi/aresetn] [get_bd_pins vip_s01_axi/aresetn] [get_bd_pins vip_s02_axi/aresetn]
  connect_bd_net -net psr_aclk_SLR2_interconnect_aresetn [get_bd_pins aresetn2] [get_bd_pins interconnect_plram_mem02/aresetn] [get_bd_pins interconnect_s03_axi/aresetn] [get_bd_pins vip_s03_axi/aresetn]
  connect_bd_net -net psr_ddr4_mem00_interconnect_aresetn [get_bd_pins aresetn3] [get_bd_pins interconnect_ddr4_mem00/aresetn]
  connect_bd_net -net psr_ddr4_mem01_interconnect_aresetn [get_bd_pins aresetn4] [get_bd_pins interconnect_ddr4_mem01/aresetn]
  connect_bd_net -net psr_ddr4_mem02_interconnect_aresetn [get_bd_pins aresetn5] [get_bd_pins interconnect_ddr4_mem02/aresetn]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net interconnect_PLRAM_MEM00_M00_AXI [get_bd_intf_pins interconnect/M00_AXI3] [get_bd_intf_pins memory/S_AXI3]
  connect_bd_intf_net -intf_net interconnect_PLRAM_MEM01_M00_AXI [get_bd_intf_pins interconnect/M00_AXI4] [get_bd_intf_pins memory/S_AXI4]
  connect_bd_intf_net -intf_net interconnect_PLRAM_MEM02_M00_AXI [get_bd_intf_pins interconnect/M00_AXI5] [get_bd_intf_pins memory/S_AXI5]
  connect_bd_intf_net -intf_net rs_M00_AXI_MEM00_M_AXI [get_bd_intf_ports M00_AXI] [get_bd_intf_pins interconnect/M00_AXI6]
  ...
  connect_bd_net -net aresetn_1 [get_bd_ports aresetn] [get_bd_pins memory/aresetn3] [get_bd_pins reset/aresetn]
  ...
  connect_bd_net -net psr_aclk2_SLR1_interconnect_aresetn [get_bd_pins interconnect/aresetn6] [get_bd_pins reset/interconnect_aresetn3]
  ...
  connect_bd_net -net psr_ddr4_mem00_interconnect_aresetn [get_bd_pins interconnect/aresetn3] [get_bd_pins memory/interconnect_aresetn]
  connect_bd_net -net psr_ddr4_mem01_interconnect_aresetn [get_bd_pins interconnect/aresetn4] [get_bd_pins memory/interconnect_aresetn1]
  connect_bd_net -net psr_ddr4_mem02_interconnect_aresetn [get_bd_pins interconnect/aresetn5] [get_bd_pins memory/interconnect_aresetn2]

  # Create address segments
  create_bd_addr_seg -range 0x000400000000 -offset 0x005000000000 [get_bd_addr_spaces S01_AXI] [get_bd_addr_segs M00_AXI/Reg] SEG_M00_AXI_Reg
  ...
  create_bd_addr_seg -range 0x000400000000 -offset 0x006000000000 [get_bd_addr_spaces S02_AXI] [get_bd_addr_segs memory/ddr4_mem01/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] SEG_ddr4_mem01_C0_DDR4_ADDRESS_BLOCK
  ...
  create_bd_addr_seg -range 0x000400000000 -offset 0x007000000000 [get_bd_addr_spaces S03_AXI] [get_bd_addr_segs memory/ddr4_mem02/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] SEG_ddr4_mem02_C0_DDR4_ADDRESS_BLOCK
  ...
  create_bd_addr_seg -range 0x00020000 -offset 0x003000200000 [get_bd_addr_spaces S02_AXI] [get_bd_addr_segs memory/plram_mem01/S_AXI/Mem0] SEG_plram_mem01_Mem0
  create_bd_addr_seg -range 0x00020000 -offset 0x003000400000 [get_bd_addr_spaces S03_AXI] [get_bd_addr_segs memory/plram_mem02/S_AXI/Mem0] SEG_plram_mem02_Mem0
