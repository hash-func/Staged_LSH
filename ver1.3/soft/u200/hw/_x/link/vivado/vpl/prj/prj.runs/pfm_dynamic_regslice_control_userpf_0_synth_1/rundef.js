...
ISEStep( "vivado",
         "-log pfm_dynamic_regslice_control_userpf_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pfm_dynamic_regslice_control_userpf_0.tcl" );
