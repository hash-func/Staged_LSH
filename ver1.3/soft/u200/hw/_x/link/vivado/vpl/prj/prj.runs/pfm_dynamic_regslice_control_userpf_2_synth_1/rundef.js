...
ISEStep( "vivado",
         "-log pfm_dynamic_regslice_control_userpf_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pfm_dynamic_regslice_control_userpf_2.tcl" );
