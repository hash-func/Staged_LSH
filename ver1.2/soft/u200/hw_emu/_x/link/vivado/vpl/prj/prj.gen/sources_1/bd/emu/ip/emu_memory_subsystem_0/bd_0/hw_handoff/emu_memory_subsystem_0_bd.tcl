...
################################################################
# This is a generated script based on design: bd_3a93
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {S04_AXI:S05_AXI:S06_AXI:S07_AXI:S08_AXI} \
 ] $aclk1
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_M01_AXI_ADDR_WIDTH {34} \
   CONFIG.C_M01_AXI_ARUSER_WIDTH {32} \
   CONFIG.C_M01_AXI_AWUSER_WIDTH {32} \
   CONFIG.C_M01_AXI_BUSER_WIDTH {1} \
   CONFIG.C_M01_AXI_DATA_WIDTH {512} \
   CONFIG.C_M01_AXI_HAS_BRESP {true} \
   CONFIG.C_M01_AXI_HAS_BURST {true} \
   CONFIG.C_M01_AXI_HAS_CACHE {true} \
   CONFIG.C_M01_AXI_HAS_LOCK {true} \
   CONFIG.C_M01_AXI_HAS_PROT {true} \
   CONFIG.C_M01_AXI_HAS_QOS {true} \
   CONFIG.C_M01_AXI_HAS_RRESP {true} \
   CONFIG.C_M01_AXI_HAS_WSTRB {true} \
   CONFIG.C_M01_AXI_ID_WIDTH {5} \
   CONFIG.C_M01_AXI_RUSER_WIDTH {1} \
   CONFIG.C_M01_AXI_WUSER_WIDTH {1} \
   ...
   CONFIG.C_S06_AXI_DATA_WIDTH {32} \
   ...
   CONFIG.C_S08_AXI_ADDR_WIDTH {64} \
   CONFIG.C_S08_AXI_ARUSER_WIDTH {0} \
   CONFIG.C_S08_AXI_AWUSER_WIDTH {0} \
   CONFIG.C_S08_AXI_BUSER_WIDTH {0} \
   CONFIG.C_S08_AXI_DATA_WIDTH {32} \
   CONFIG.C_S08_AXI_HAS_BRESP {true} \
   CONFIG.C_S08_AXI_HAS_BURST {false} \
   CONFIG.C_S08_AXI_HAS_CACHE {true} \
   CONFIG.C_S08_AXI_HAS_LOCK {true} \
   CONFIG.C_S08_AXI_HAS_PROT {true} \
   CONFIG.C_S08_AXI_HAS_QOS {true} \
   CONFIG.C_S08_AXI_HAS_REGION {true} \
   CONFIG.C_S08_AXI_HAS_RRESP {true} \
   CONFIG.C_S08_AXI_HAS_WSTRB {true} \
   CONFIG.C_S08_AXI_ID_WIDTH {0} \
   CONFIG.C_S08_AXI_RUSER_WIDTH {0} \
   CONFIG.C_S08_AXI_WUSER_WIDTH {0} \
  ...
  connect_bd_intf_net -intf_net S08_AXI_1 [get_bd_intf_ports S08_AXI] [get_bd_intf_pins xtlm_simple_intercon_0/S08_AXI]
  ...
  connect_bd_net -net aclk1_1 [get_bd_ports aclk1] [get_bd_pins xtlm_simple_intercon_0/s04_axi_aclk] [get_bd_pins xtlm_simple_intercon_0/s05_axi_aclk] [get_bd_pins xtlm_simple_intercon_0/s06_axi_aclk] [get_bd_pins xtlm_simple_intercon_0/s07_axi_aclk] [get_bd_pins xtlm_simple_intercon_0/s08_axi_aclk]
  ...
  connect_bd_net -net aresetn_1 [get_bd_ports aresetn] [get_bd_pins plram_0/s00_axi_aresetn] [get_bd_pins plram_1/s00_axi_aresetn] [get_bd_pins plram_2/s00_axi_aresetn] [get_bd_pins xtlm_simple_intercon_0/m00_axi_aresetn] [get_bd_pins xtlm_simple_intercon_0/m01_axi_aresetn] [get_bd_pins xtlm_simple_intercon_0/m02_axi_aresetn] [get_bd_pins xtlm_simple_intercon_0/m03_axi_aresetn] [get_bd_pins xtlm_simple_intercon_0/m04_axi_aresetn] [get_bd_pins xtlm_simple_intercon_0/m05_axi_aresetn] [get_bd_pins xtlm_simple_intercon_0/m06_axi_aresetn] [get_bd_pins xtlm_simple_intercon_0/s00_axi_aresetn] [get_bd_pins xtlm_simple_intercon_0/s01_axi_aresetn] [get_bd_pins xtlm_simple_intercon_0/s02_axi_aresetn] [get_bd_pins xtlm_simple_intercon_0/s03_axi_aresetn] [get_bd_pins xtlm_simple_intercon_0/s04_axi_aresetn] [get_bd_pins xtlm_simple_intercon_0/s05_axi_aresetn] [get_bd_pins xtlm_simple_intercon_0/s06_axi_aresetn] [get_bd_pins xtlm_simple_intercon_0/s07_axi_aresetn] [get_bd_pins xtlm_simple_intercon_0/s08_axi_aresetn]

  # Create address segments
  assign_bd_address -offset 0x000C00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S00_AXI] [get_bd_addr_segs M03_AXI/Reg] -force
  assign_bd_address -offset 0x000C00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S08_AXI] [get_bd_addr_segs M03_AXI/Reg] -force
  assign_bd_address -offset 0x000400000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S01_AXI] [get_bd_addr_segs M01_AXI/Reg] -force
  assign_bd_address -offset 0x000C00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S02_AXI] [get_bd_addr_segs M03_AXI/Reg] -force
  assign_bd_address -offset 0x000C00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S07_AXI] [get_bd_addr_segs M03_AXI/Reg] -force
  assign_bd_address -offset 0x000400000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S06_AXI] [get_bd_addr_segs M01_AXI/Reg] -force
  assign_bd_address -offset 0x000C00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S03_AXI] [get_bd_addr_segs M03_AXI/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S05_AXI] [get_bd_addr_segs M00_AXI/Reg] -force
  assign_bd_address -offset 0x000C00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S04_AXI] [get_bd_addr_segs M03_AXI/Reg] -force
  assign_bd_address -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S00_AXI] [get_bd_addr_segs M02_AXI/Reg] -force
  assign_bd_address -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S08_AXI] [get_bd_addr_segs M02_AXI/Reg] -force
  assign_bd_address -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S07_AXI] [get_bd_addr_segs M02_AXI/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S06_AXI] [get_bd_addr_segs M00_AXI/Reg] -force
  assign_bd_address -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S04_AXI] [get_bd_addr_segs M02_AXI/Reg] -force
  assign_bd_address -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S03_AXI] [get_bd_addr_segs M02_AXI/Reg] -force
  assign_bd_address -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S02_AXI] [get_bd_addr_segs M02_AXI/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S01_AXI] [get_bd_addr_segs M00_AXI/Reg] -force
  assign_bd_address -offset 0x000400000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S03_AXI] [get_bd_addr_segs M01_AXI/Reg] -force
  assign_bd_address -offset 0x000400000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S04_AXI] [get_bd_addr_segs M01_AXI/Reg] -force
  assign_bd_address -offset 0x000400000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S02_AXI] [get_bd_addr_segs M01_AXI/Reg] -force
  assign_bd_address -offset 0x000400000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S07_AXI] [get_bd_addr_segs M01_AXI/Reg] -force
  assign_bd_address -offset 0x000400000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S00_AXI] [get_bd_addr_segs M01_AXI/Reg] -force
  assign_bd_address -offset 0x000400000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S08_AXI] [get_bd_addr_segs M01_AXI/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S03_AXI] [get_bd_addr_segs M00_AXI/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S04_AXI] [get_bd_addr_segs M00_AXI/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S02_AXI] [get_bd_addr_segs M00_AXI/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S07_AXI] [get_bd_addr_segs M00_AXI/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S00_AXI] [get_bd_addr_segs M00_AXI/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S08_AXI] [get_bd_addr_segs M00_AXI/Reg] -force
