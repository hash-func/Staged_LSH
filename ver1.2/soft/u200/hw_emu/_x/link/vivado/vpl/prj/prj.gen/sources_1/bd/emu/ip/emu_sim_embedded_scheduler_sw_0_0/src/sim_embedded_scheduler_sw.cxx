...
sim_embedded_scheduler_sw::sim_embedded_scheduler_sw(const sc_core::sc_module_name &name,xsc::common_cpp::properties&) : sc_module(name) ,
...
maxi_lite_mb_aresetn("maxi_lite_mb_aresetn")
{
  ...
  m_imp=new sim_embedded_scheduler_sw_imp("sim_embedded_scheduler_sw_imp");
