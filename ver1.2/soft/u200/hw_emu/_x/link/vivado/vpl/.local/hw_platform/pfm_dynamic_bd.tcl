...
proc create_hier_cell_slr1 { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_gpio_null/s_axi_aresetn] [get_bd_pins axi_vip_ctrl_mgntpf/aresetn] [get_bd_pins axi_vip_ctrl_userpf/aresetn] [get_bd_pins freq_counter_0/reset_n] [get_bd_pins interconnect_axilite_user/ARESETN] [get_bd_pins interconnect_axilite_user/M00_ARESETN] [get_bd_pins interconnect_axilite_user/S00_ARESETN] [get_bd_pins regslice_control_mgntpf/aresetn] [get_bd_pins regslice_control_userpf/aresetn] [get_bd_pins reset_controllers/psreset_gate_pr_control_interconnect_aresetn]
  ...
  connect_bd_net -net slowest_sync_clk_1 [get_bd_pins clkwiz_sysclks_clk_out2] [get_bd_pins axi_gpio_null/s_axi_aclk] [get_bd_pins axi_vip_ctrl_mgntpf/aclk] [get_bd_pins axi_vip_ctrl_userpf/aclk] [get_bd_pins freq_counter_0/clk] [get_bd_pins interconnect_axilite_user/ACLK] [get_bd_pins interconnect_axilite_user/M00_ACLK] [get_bd_pins interconnect_axilite_user/S00_ACLK] [get_bd_pins regslice_control_mgntpf/aclk] [get_bd_pins regslice_control_userpf/aclk] [get_bd_pins reset_controllers/clkwiz_sysclks_clk_out2]
...
proc create_root_design { parentCell } {
  ...
  set interconnect_aximm_ddrmem1_M00_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 interconnect_aximm_ddrmem1_M00_AXI ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {39} \
   CONFIG.DATA_WIDTH {512} \
   CONFIG.FREQ_HZ {300000000} \
  ...
  set regslice_control_userpf_M_AXI_slr0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 regslice_control_userpf_M_AXI_slr0 ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {25} \
   CONFIG.ARUSER_WIDTH {0} \
   CONFIG.AWUSER_WIDTH {0} \
  ...
  set regslice_control_userpf_M_AXI_slr2 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 regslice_control_userpf_M_AXI_slr2 ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {25} \
   CONFIG.ARUSER_WIDTH {0} \
   CONFIG.AWUSER_WIDTH {0} \
  ...
  set regslice_data_dynamic_M_AXI_slr1 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 regslice_data_dynamic_M_AXI_slr1 ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {38} \
   CONFIG.ARUSER_WIDTH {0} \
   CONFIG.AWUSER_WIDTH {0} \
  ...
  set ddrmem_1_c0_ddr4_ui_clk [ create_bd_port -dir I -type clk ddrmem_1_c0_ddr4_ui_clk ]
  set_property -dict [ list \
  ...
  # Create port connections
  connect_bd_net -net M01_ACLK_1 [get_bd_ports clkwiz_kernel_clk_out1] [get_bd_pins memory_subsystem/aclk] [get_bd_pins slr0/clkwiz_kernel_clk_out1] [get_bd_pins slr1/clkwiz_kernel_clk_out1] [get_bd_pins slr2/clkwiz_kernel_clk_out1]
  connect_bd_net -net aclk_0_1 [get_bd_ports dma_pcie_axi_aclk] [get_bd_pins regslice_periph_null/aclk] [get_bd_pins slr0/dma_pcie_axi_aclk] [get_bd_pins slr1/dma_pcie_axi_aclk] [get_bd_pins slr2/dma_pcie_axi_aclk]
  ...
  connect_bd_net -net slowest_sync_clk_1 [get_bd_ports clkwiz_sysclks_clk_out2] [get_bd_pins debug_bridge_xsdbm/clk] [get_bd_pins memory_subsystem/aclk1] [get_bd_pins slr0/clkwiz_sysclks_clk_out2] [get_bd_pins slr1/clkwiz_sysclks_clk_out2] [get_bd_pins slr2/clkwiz_sysclks_clk_out2]
  ...
  create_bd_addr_seg -range 0x000400000000 -offset 0x005000000000 [get_bd_addr_spaces memory_subsystem/M00_AXI] [get_bd_addr_segs interconnect_aximm_ddrmem1_M00_AXI/Reg] SEG_interconnect_aximm_ddrmem1_M00_AXI_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x01DFF000 [get_bd_addr_spaces regslice_control_userpf_M_AXI_slr0] [get_bd_addr_segs slr0/axi_gpio_null/S_AXI/Reg] SEG_axi_gpio_null_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x01BFF000 [get_bd_addr_spaces regslice_control_userpf_M_AXI_slr1] [get_bd_addr_segs slr1/axi_gpio_null/S_AXI/Reg] SEG_axi_gpio_null_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x01FEF000 [get_bd_addr_spaces regslice_control_userpf_M_AXI_slr2] [get_bd_addr_segs slr2/axi_gpio_null/S_AXI/Reg] SEG_axi_gpio_null_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x00052000 [get_bd_addr_spaces regslice_control_periph_M_AXI_slr1] [get_bd_addr_segs slr1/freq_counter_0/axil/reg0] SEG_freq_counter_0_reg0
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x01000000 [get_bd_addr_spaces regslice_control_M_AXI_slr1] [get_bd_addr_segs memory_subsystem/S_AXI_CTRL/DDR4_MEM00_CTRL] SEG_memory_subsystem_DDR4_MEM00_CTRL
  create_bd_addr_seg -range 0x000400000000 -offset 0x006000000000 [get_bd_addr_spaces regslice_data_dynamic_M_AXI_slr1] [get_bd_addr_segs memory_subsystem/S02_AXI/DDR4_MEM01] SEG_memory_subsystem_DDR4_MEM01
  create_bd_addr_seg -range 0x00010000 -offset 0x01010000 [get_bd_addr_spaces regslice_control_M_AXI_slr1] [get_bd_addr_segs memory_subsystem/S_AXI_CTRL/DDR4_MEM01_CTRL] SEG_memory_subsystem_DDR4_MEM01_CTRL
  create_bd_addr_seg -range 0x000400000000 -offset 0x007000000000 [get_bd_addr_spaces regslice_data_M_AXI_slr2] [get_bd_addr_segs memory_subsystem/S03_AXI/DDR4_MEM02] SEG_memory_subsystem_DDR4_MEM02
  create_bd_addr_seg -range 0x00010000 -offset 0x01020000 [get_bd_addr_spaces regslice_control_M_AXI_slr1] [get_bd_addr_segs memory_subsystem/S_AXI_CTRL/DDR4_MEM02_CTRL] SEG_memory_subsystem_DDR4_MEM02_CTRL
  create_bd_addr_seg -range 0x000400000000 -offset 0x005000000000 [get_bd_addr_spaces regslice_data_static_M_AXI_slr1] [get_bd_addr_segs memory_subsystem/S01_AXI/M00_AXI_MEM00] SEG_memory_subsystem_M00_AXI_MEM00
  ...
  create_bd_addr_seg -range 0x00020000 -offset 0x003000200000 [get_bd_addr_spaces regslice_data_dynamic_M_AXI_slr1] [get_bd_addr_segs memory_subsystem/S02_AXI/PLRAM_MEM01] SEG_memory_subsystem_PLRAM_MEM01
  create_bd_addr_seg -range 0x00020000 -offset 0x003000400000 [get_bd_addr_spaces regslice_data_M_AXI_slr2] [get_bd_addr_segs memory_subsystem/S03_AXI/PLRAM_MEM02] SEG_memory_subsystem_PLRAM_MEM02
