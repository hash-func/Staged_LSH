...
set Library     "hls"
set IPName      "table_serch"
set Version     "1.0"
set DisplayName "Table_serch"
set Revision    "2112460380"
...
set xo_kernel_name "table_serch"
set xo_kernel_files {}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/nomoto/src/StagedLSH/ver1.2/soft/u200/hw_emu/_x/table_serch/table_serch/table_serch/solution"
set debug_dir "/home/nomoto/src/StagedLSH/ver1.2/soft/u200/hw_emu/_x/table_serch/table_serch/table_serch/solution/.debug"
set xo_hls_files_dir ""
set hdl_module_list {table_serch_control_s_axi
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 query_1 W 0x0 "Data signal of query" {{0 32 query W 0 "Bit 31 to 0 of query"}}} {0x14 query_2 W 0x0 "Data signal of query" {{0 32 query W 0 "Bit 63 to 32 of query"}}} {0x1c FP_DB_1 W 0x0 "Data signal of FP_DB" {{0 32 FP_DB W 0 "Bit 31 to 0 of FP_DB"}}} {0x20 FP_DB_2 W 0x0 "Data signal of FP_DB" {{0 32 FP_DB W 0 "Bit 63 to 32 of FP_DB"}}} {0x28 hash_table_1 W 0x0 "Data signal of hash_table" {{0 32 hash_table W 0 "Bit 31 to 0 of hash_table"}}} {0x2c hash_table_2 W 0x0 "Data signal of hash_table" {{0 32 hash_table W 0 "Bit 63 to 32 of hash_table"}}} {0x34 hash_table_pointer_1 W 0x0 "Data signal of hash_table_pointer" {{0 32 hash_table_pointer W 0 "Bit 31 to 0 of hash_table_pointer"}}} {0x38 hash_table_pointer_2 W 0x0 "Data signal of hash_table_pointer" {{0 32 hash_table_pointer W 0 "Bit 63 to 32 of hash_table_pointer"}}} {0x40 judge_temp_1 W 0x0 "Data signal of judge_temp" {{0 32 judge_temp W 0 "Bit 31 to 0 of judge_temp"}}} {0x44 judge_temp_2 W 0x0 "Data signal of judge_temp" {{0 32 judge_temp W 0 "Bit 63 to 32 of judge_temp"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_plram0 m_axi_aximm0 m_axi_aximm1 m_axi_aximm2 m_axi_gmem"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_plram0 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_plram0"
        data_width "512"
        param_prefix "C_M_AXI_PLRAM0"
    ...
    m_axi_aximm0 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_aximm0"
        data_width "512"
        param_prefix "C_M_AXI_AXIMM0"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 512 WSTRB 64 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 512 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_aximm1 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_aximm1"
        data_width "32"
        param_prefix "C_M_AXI_AXIMM1"
    ...
    m_axi_aximm2 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_aximm2"
        data_width "32"
        param_prefix "C_M_AXI_AXIMM2"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
source -notrace "/opt/Vitis_HLS/2020.2/common/scripts/ipxhls.tcl"
