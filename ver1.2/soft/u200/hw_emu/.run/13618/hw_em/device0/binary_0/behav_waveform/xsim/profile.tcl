...
proc getTraceEvents {kernelName cuName moduleName signal targetValue {requireEnd 0}} {
  ...
  set startTimeMsec 0
  set factor 9.0
  set currDeviceName xilinx_u200_xdma_201830_2-0
  set currBinaryName table_serch
...
# Compute Unit Stalls
#
set computeUnits { table_serch_1 }
...
# Compute Unit Ports
#
set computeUnits { table_serch_1 table_serch_1 table_serch_1 table_serch_1 table_serch_1 }
set ports { m_axi_plram0 m_axi_aximm0 m_axi_aximm1 m_axi_aximm2 m_axi_gmem }
set readBusySignals { /emu_wrapper/emu_i/table_serch_1/m_axi_plram0.readActive /emu_wrapper/emu_i/table_serch_1/m_axi_aximm0.readActive /emu_wrapper/emu_i/table_serch_1/m_axi_aximm1.readActive /emu_wrapper/emu_i/table_serch_1/m_axi_aximm2.readActive /emu_wrapper/emu_i/table_serch_1/m_axi_gmem.readActive }
set writeBusySignals { /emu_wrapper/emu_i/table_serch_1/m_axi_plram0.writeActive /emu_wrapper/emu_i/table_serch_1/m_axi_aximm0.writeActive /emu_wrapper/emu_i/table_serch_1/m_axi_aximm1.writeActive /emu_wrapper/emu_i/table_serch_1/m_axi_aximm2.writeActive /emu_wrapper/emu_i/table_serch_1/m_axi_gmem.writeActive }
