; ModuleID = '/home/nomoto/src/StagedLSH/ver1.2/soft/u200/sw_emu/_x/table_serch/table_serch/table_serch/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call fastcc void @copy_in([512 x i32]* %0, [512 x i32]* nonnull align 512 %query_copy, [153600 x i32]* %1, [153600 x i32]* %FP_DB_copy, [302400 x i32]* %2, [302400 x i32]* %hash_table_copy, [64512 x i32]* %3, [64512 x i32]* %hash_table_pointer_copy, [4 x i32]* %4, [4 x i32]* nonnull align 512 %judge_temp_copy)
  ...
  %7 = getelementptr inbounds [302400 x i32], [302400 x i32]* %hash_table_copy, i32 0, i32 0
  %8 = getelementptr inbounds [64512 x i32], [64512 x i32]* %hash_table_pointer_copy, i32 0, i32 0
  ...
  call fastcc void @copy_out([512 x i32]* %0, [512 x i32]* nonnull align 512 %query_copy, [153600 x i32]* %1, [153600 x i32]* %FP_DB_copy, [302400 x i32]* %2, [302400 x i32]* %hash_table_copy, [64512 x i32]* %3, [64512 x i32]* %hash_table_pointer_copy, [4 x i32]* %4, [4 x i32]* nonnull align 512 %judge_temp_copy)
...
define internal fastcc void @copy_in([512 x i32]* readonly, [512 x i32]* noalias align 512, [153600 x i32]* readonly, [153600 x i32]* noalias, [302400 x i32]* readonly, [302400 x i32]* noalias, [64512 x i32]* readonly, [64512 x i32]* noalias, [4 x i32]* readonly, [4 x i32]* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out([512 x i32]*, [512 x i32]* noalias readonly align 512, [153600 x i32]*, [153600 x i32]* noalias readonly, [302400 x i32]*, [302400 x i32]* noalias readonly, [64512 x i32]*, [64512 x i32]* noalias readonly, [4 x i32]*, [4 x i32]* noalias readonly align 512) unnamed_addr #4 {
entry:
...
entry:
  ...
  call void @copy_out([512 x i32]* null, [512 x i32]* %5, [153600 x i32]* null, [153600 x i32]* %6, [302400 x i32]* null, [302400 x i32]* %7, [64512 x i32]* null, [64512 x i32]* %8, [4 x i32]* null, [4 x i32]* %9)
  %10 = bitcast [512 x i32]* %5 to i32*
  %11 = bitcast [153600 x i32]* %6 to i32*
  %12 = bitcast [302400 x i32]* %7 to i32*
  %13 = bitcast [64512 x i32]* %8 to i32*
  %14 = bitcast [4 x i32]* %9 to i32*
  call void @table_serch_hw_stub(i32* %10, i32* %11, i32* %12, i32* %13, i32* %14)
  call void @copy_in([512 x i32]* null, [512 x i32]* %5, [153600 x i32]* null, [153600 x i32]* %6, [302400 x i32]* null, [302400 x i32]* %7, [64512 x i32]* null, [64512 x i32]* %8, [4 x i32]* null, [4 x i32]* %9)
  ret void
}
