...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./prj/prj.gen/my_rm/bd/bd/ip/pfm_dynamic_memory_subsystem_0/bd_4
...
proc create_hier_cell_s00_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.READ_WRITE_MODE {READ_WRITE} \
   CONFIG.SEG000_BASE_ADDR {0x0000006000000000} \
...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SSC004_ROUTE {0b01} \
   CONFIG.SSC005_ROUTE {0b00} \
   CONFIG.SSC006_ROUTE {0b00} \
   CONFIG.SSC007_ROUTE {0b10} \
   CONFIG.SSC008_ROUTE {0b00} \
   CONFIG.SSC009_ROUTE {0b00} \
   CONFIG.SSC010_ROUTE {0b00} \
   CONFIG.SSC011_ROUTE {0b00} \
   CONFIG.SSC012_ROUTE {0b00} \
   CONFIG.SSC013_ROUTE {0b00} \
   CONFIG.SSC014_ROUTE {0b00} \
   CONFIG.SSC015_ROUTE {0b00} \
...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net clk_map_aclk1_net [get_bd_pins S00_ACLK] [get_bd_pins S01_ACLK] [get_bd_pins aclk1] [get_bd_pins psr0/slowest_sync_clk] [get_bd_pins psr_aclk1/slowest_sync_clk]
  ...
  connect_bd_net -net psr_aclk1_interconnect_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins S01_ARESETN] [get_bd_pins psr_aclk1/interconnect_aresetn]
