...
################################################################
# This is a generated script based on design: bd_2b97
#
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./prj/prj.gen/my_rm/bd/bd/ip/pfm_dynamic_memory_subsystem_0/bd_5
...
proc create_hier_cell_s01_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG000_BASE_ADDR {0x0000005000000000} \
