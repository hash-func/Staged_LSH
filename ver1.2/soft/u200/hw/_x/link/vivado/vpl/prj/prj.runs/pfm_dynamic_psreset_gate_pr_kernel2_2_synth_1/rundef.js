...
ISEStep( "vivado",
         "-log pfm_dynamic_psreset_gate_pr_kernel2_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pfm_dynamic_psreset_gate_pr_kernel2_2.tcl" );
