...
create_clock -name ddrmem_1_c0_ddr4_ui_clk -period 3.333 [get_ports ddrmem_1_c0_ddr4_ui_clk]
...
create_clock -name public_debug_hub_drck -period 10 [get_ports public_debug_hub_drck]
create_clock -name public_debug_hub_tck -period 10 [get_ports public_debug_hub_tck]
create_clock -name public_debug_hub_update -period 10 [get_ports public_debug_hub_update]
