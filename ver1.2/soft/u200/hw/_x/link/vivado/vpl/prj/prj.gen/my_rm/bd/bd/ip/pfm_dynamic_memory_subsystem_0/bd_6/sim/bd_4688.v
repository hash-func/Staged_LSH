...
(* CORE_GENERATION_INFO = "bd_4688,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_4688,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=40,numReposBlks=32,numNonXlnxBlks=0,numHierBlks=8,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "bd_d216_interconnect_PLRAM_MEM00_0.hwdef" *) 
module bd_4688
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
  ...
  m00_nodes_imp_1R0ION0 m00_nodes
  ...
  s01_entry_pipeline_imp_1BKMLL3 s01_entry_pipeline
       (.aclk(aclk_2),
        .aresetn(aresetn_3),
  ...
  s01_nodes_imp_1F8UMBJ s01_nodes
  ...
  switchboards_imp_LQ05Y5 switchboards
...
module s01_entry_pipeline_imp_1BKMLL3
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_4688_s01mmu_0 s01_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_wuser(s_axi_1_WUSER),
        .s_axi_wvalid(s_axi_1_WVALID));
  bd_4688_s01sic_0 s01_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_4688_s01tr_0 s01_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
...
module switchboards_imp_LQ05Y5
   (M00_SC_AR_info,
    M00_SC_AR_payld,
    M00_SC_AR_recv,
    M00_SC_AR_req,
