...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_pointer1 \
    op interface \
    ports { m_axi_pointer1_AWVALID { O 1 bit } m_axi_pointer1_AWREADY { I 1 bit } m_axi_pointer1_AWADDR { O 64 vector } m_axi_pointer1_AWID { O 1 vector } m_axi_pointer1_AWLEN { O 32 vector } m_axi_pointer1_AWSIZE { O 3 vector } m_axi_pointer1_AWBURST { O 2 vector } m_axi_pointer1_AWLOCK { O 2 vector } m_axi_pointer1_AWCACHE { O 4 vector } m_axi_pointer1_AWPROT { O 3 vector } m_axi_pointer1_AWQOS { O 4 vector } m_axi_pointer1_AWREGION { O 4 vector } m_axi_pointer1_AWUSER { O 1 vector } m_axi_pointer1_WVALID { O 1 bit } m_axi_pointer1_WREADY { I 1 bit } m_axi_pointer1_WDATA { O 32 vector } m_axi_pointer1_WSTRB { O 4 vector } m_axi_pointer1_WLAST { O 1 bit } m_axi_pointer1_WID { O 1 vector } m_axi_pointer1_WUSER { O 1 vector } m_axi_pointer1_ARVALID { O 1 bit } m_axi_pointer1_ARREADY { I 1 bit } m_axi_pointer1_ARADDR { O 64 vector } m_axi_pointer1_ARID { O 1 vector } m_axi_pointer1_ARLEN { O 32 vector } m_axi_pointer1_ARSIZE { O 3 vector } m_axi_pointer1_ARBURST { O 2 vector } m_axi_pointer1_ARLOCK { O 2 vector } m_axi_pointer1_ARCACHE { O 4 vector } m_axi_pointer1_ARPROT { O 3 vector } m_axi_pointer1_ARQOS { O 4 vector } m_axi_pointer1_ARREGION { O 4 vector } m_axi_pointer1_ARUSER { O 1 vector } m_axi_pointer1_RVALID { I 1 bit } m_axi_pointer1_RREADY { O 1 bit } m_axi_pointer1_RDATA { I 32 vector } m_axi_pointer1_RLAST { I 1 bit } m_axi_pointer1_RID { I 1 vector } m_axi_pointer1_RUSER { I 1 vector } m_axi_pointer1_RRESP { I 2 vector } m_axi_pointer1_BVALID { I 1 bit } m_axi_pointer1_BREADY { O 1 bit } m_axi_pointer1_BRESP { I 2 vector } m_axi_pointer1_BID { I 1 vector } m_axi_pointer1_BUSER { I 1 vector } } \
} "
}
