; ModuleID = '/home/nomoto/src/StagedLSH/ver1.2/hard/workplace/StagedLSH_ver1.2/solution2/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define i32 @apatb_table_serch_ir(i32* %query, i32* %FP_DB, i32* %hash_table, i32* %hash_table_pointer) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_in([512 x i32]* %0, [512 x i32]* nonnull align 512 %query_copy, [153600 x i32]* %1, [153600 x i32]* %FP_DB_copy, [302400 x i32]* %2, [302400 x i32]* %hash_table_copy, [64512 x i32]* %3, [64512 x i32]* %hash_table_pointer_copy)
  ...
  %8 = call i32 @apatb_table_serch_hw(i32* %4, i32* %5, i32* %6, i32* %7)
  call fastcc void @copy_out([512 x i32]* %0, [512 x i32]* nonnull align 512 %query_copy, [153600 x i32]* %1, [153600 x i32]* %FP_DB_copy, [302400 x i32]* %2, [302400 x i32]* %hash_table_copy, [64512 x i32]* %3, [64512 x i32]* %hash_table_pointer_copy)
...
define internal fastcc void @copy_in([512 x i32]* readonly, [512 x i32]* noalias align 512, [153600 x i32]* readonly, [153600 x i32]* noalias, [302400 x i32]* readonly, [302400 x i32]* noalias, [64512 x i32]* readonly, [64512 x i32]* noalias) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out([512 x i32]*, [512 x i32]* noalias readonly align 512, [153600 x i32]*, [153600 x i32]* noalias readonly, [302400 x i32]*, [302400 x i32]* noalias readonly, [64512 x i32]*, [64512 x i32]* noalias readonly) unnamed_addr #4 {
entry:
...
declare i32 @apatb_table_serch_hw(i32*, i32*, i32*, i32*)

define i32 @table_serch_hw_stub_wrapper(i32*, i32*, i32*, i32*) #5 {
entry:
  %4 = bitcast i32* %0 to [512 x i32]*
  %5 = bitcast i32* %1 to [153600 x i32]*
  %6 = bitcast i32* %2 to [302400 x i32]*
  %7 = bitcast i32* %3 to [64512 x i32]*
  call void @copy_out([512 x i32]* null, [512 x i32]* %4, [153600 x i32]* null, [153600 x i32]* %5, [302400 x i32]* null, [302400 x i32]* %6, [64512 x i32]* null, [64512 x i32]* %7)
  %8 = bitcast [512 x i32]* %4 to i32*
  %9 = bitcast [153600 x i32]* %5 to i32*
  %10 = bitcast [302400 x i32]* %6 to i32*
  %11 = bitcast [64512 x i32]* %7 to i32*
  %12 = call i32 @table_serch_hw_stub(i32* %8, i32* %9, i32* %10, i32* %11)
  call void @copy_in([512 x i32]* null, [512 x i32]* %4, [153600 x i32]* null, [153600 x i32]* %5, [302400 x i32]* null, [302400 x i32]* %6, [64512 x i32]* null, [64512 x i32]* %7)
  ret i32 %12
}

declare i32 @table_serch_hw_stub(i32*, i32*, i32*, i32*)
