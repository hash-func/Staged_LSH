...
#define XKERNEL_CONTROL_ADDR_ARRAY_1_DATA 0x10
#define XKERNEL_CONTROL_BITS_ARRAY_1_DATA 64
#define XKERNEL_CONTROL_ADDR_SUM_DATA     0x1c
#define XKERNEL_CONTROL_BITS_SUM_DATA     32
