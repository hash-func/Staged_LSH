...
`define AESL_DEPTH_pointer_a 1
`define AUTOTB_TVIN_gmem  "./c.kernel.autotvin_gmem.dat"
`define AUTOTB_TVIN_b  "./c.kernel.autotvin_b.dat"
`define AUTOTB_TVIN_pointer_a  "./c.kernel.autotvin_pointer_a.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.kernel.autotvin_gmem.dat"
`define AUTOTB_TVIN_b_out_wrapc  "./rtl.kernel.autotvin_b.dat"
`define AUTOTB_TVIN_pointer_a_out_wrapc  "./rtl.kernel.autotvin_pointer_a.dat"
`define AUTOTB_TVOUT_ap_return  "./c.kernel.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.kernel.autotvout_ap_return.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 72;
parameter LENGTH_gmem = 1;
parameter LENGTH_a = 1;
parameter LENGTH_b = 1;
parameter LENGTH_pointer_a = 1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.kernel.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.kernel.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.kernel.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.kernel.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.kernel.autotvout_ap_return.dat with impl_rtl.kernel.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
reg end_pointer_a;
reg [31:0] size_pointer_a;
reg [31:0] size_pointer_a_backup;
reg end_ap_return;
