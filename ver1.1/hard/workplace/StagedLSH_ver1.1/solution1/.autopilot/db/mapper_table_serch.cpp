...
extern "C" int table_serch(__cosim_s40__*, int, int, int, int);
extern "C" int apatb_table_serch_hw(volatile void * __xlx_apatb_param_query, volatile void * __xlx_apatb_param_FP_DB, volatile void * __xlx_apatb_param_hash_table, volatile void * __xlx_apatb_param_hash_table_pointer) {
  // Collect __xlx_query_FP_DB_hash_table_hash_table_pointer__tmp_vec
  vector<sc_bv<512> >__xlx_query_FP_DB_hash_table_hash_table_pointer__tmp_vec;
  for (int j = 0, e = 1; j != e; ++j) {
    ...
    __xlx_query_FP_DB_hash_table_hash_table_pointer__tmp_vec.push_back(_xlx_tmp_sc);
  }
  ...
  __cosim_s40__* __xlx_query_FP_DB_hash_table_hash_table_pointer__input_buffer= new __cosim_s40__[__xlx_query_FP_DB_hash_table_hash_table_pointer__tmp_vec.size()];
  for (int i = 0; i < __xlx_query_FP_DB_hash_table_hash_table_pointer__tmp_vec.size(); ++i) {
    ((long long*)__xlx_query_FP_DB_hash_table_hash_table_pointer__input_buffer)[i*8+0] = __xlx_query_FP_DB_hash_table_hash_table_pointer__tmp_vec[i].range(63, 0).to_uint64();
    ((long long*)__xlx_query_FP_DB_hash_table_hash_table_pointer__input_buffer)[i*8+1] = __xlx_query_FP_DB_hash_table_hash_table_pointer__tmp_vec[i].range(127, 64).to_uint64();
    ((long long*)__xlx_query_FP_DB_hash_table_hash_table_pointer__input_buffer)[i*8+2] = __xlx_query_FP_DB_hash_table_hash_table_pointer__tmp_vec[i].range(191, 128).to_uint64();
    ((long long*)__xlx_query_FP_DB_hash_table_hash_table_pointer__input_buffer)[i*8+3] = __xlx_query_FP_DB_hash_table_hash_table_pointer__tmp_vec[i].range(255, 192).to_uint64();
    ((long long*)__xlx_query_FP_DB_hash_table_hash_table_pointer__input_buffer)[i*8+4] = __xlx_query_FP_DB_hash_table_hash_table_pointer__tmp_vec[i].range(319, 256).to_uint64();
    ((long long*)__xlx_query_FP_DB_hash_table_hash_table_pointer__input_buffer)[i*8+5] = __xlx_query_FP_DB_hash_table_hash_table_pointer__tmp_vec[i].range(383, 320).to_uint64();
    ((long long*)__xlx_query_FP_DB_hash_table_hash_table_pointer__input_buffer)[i*8+6] = __xlx_query_FP_DB_hash_table_hash_table_pointer__tmp_vec[i].range(447, 384).to_uint64();
    ((long long*)__xlx_query_FP_DB_hash_table_hash_table_pointer__input_buffer)[i*8+7] = __xlx_query_FP_DB_hash_table_hash_table_pointer__tmp_vec[i].range(511, 448).to_uint64();
  }
  // DUT call
  int ap_return = table_serch(__xlx_query_FP_DB_hash_table_hash_table_pointer__input_buffer, __xlx_offset_byte_param_query, __xlx_offset_byte_param_FP_DB, __xlx_offset_byte_param_hash_table, __xlx_offset_byte_param_hash_table_pointer);
// print __xlx_apatb_param_query
  ...
  for (int i = 0; i < __xlx_size_param_query; ++i) {
    char* start = (char*)(&(__xlx_query_FP_DB_hash_table_hash_table_pointer__input_buffer[__xlx_offset_param_query]));
...
// print __xlx_apatb_param_FP_DB
  ...
  for (int i = 0; i < __xlx_size_param_FP_DB; ++i) {
    char* start = (char*)(&(__xlx_query_FP_DB_hash_table_hash_table_pointer__input_buffer[__xlx_offset_param_FP_DB]));
...
// print __xlx_apatb_param_hash_table
  ...
  for (int i = 0; i < __xlx_size_param_hash_table; ++i) {
    char* start = (char*)(&(__xlx_query_FP_DB_hash_table_hash_table_pointer__input_buffer[__xlx_offset_param_hash_table]));
...
// print __xlx_apatb_param_hash_table_pointer
  ...
  for (int i = 0; i < __xlx_size_param_hash_table_pointer; ++i) {
    char* start = (char*)(&(__xlx_query_FP_DB_hash_table_hash_table_pointer__input_buffer[__xlx_offset_param_hash_table_pointer]));
