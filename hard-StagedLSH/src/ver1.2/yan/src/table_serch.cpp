...
#pragma HLS shared variable=index_array

// 配列の分割、ポート数の拡張
// #pragma HLS array_partition variable=query cyclic factor=6 dim=1
// #pragma HLS array_partition variable=FP_DB cyclic factor=6 dim=1
// #pragma HLS array_partition variable=hash_table cyclic factor=6 dim=1
// #pragma HLS array_partition variable=hash_table_pointer cyclic factor=6 dim=1
#pragma HLS array_partition variable=index_array cyclic factor=6 dim=1
