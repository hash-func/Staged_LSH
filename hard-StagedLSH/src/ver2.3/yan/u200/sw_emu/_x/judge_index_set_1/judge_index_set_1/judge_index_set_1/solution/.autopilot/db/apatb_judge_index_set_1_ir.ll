; ModuleID = '/home/nomoto/src/StagedLSH/hard-StagedLSH/src/ver2.3/yan/u200/sw_emu/_x/judge_index_set_1/judge_index_set_1/judge_index_set_1/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_judge_index_set_1_ir(i32* %FP_DB, i32* %hash_table, %"class.hls::stream"* %complete_stream_in, %"class.hls::stream.0"* %fp32_stream_out, %"class.hls::stream.0"* %haming_stream_in, %"class.hls::stream.0"* %index_stream_out, %"class.hls::stream.0"* %locate_stream_in, %"class.hls::stream.0"* %count_stream_in) local_unnamed_addr #0 {
entry:
  ...
  %fp32_stream_out_copy = alloca %"class.hls::stream.0", align 512
  %haming_stream_in_copy = alloca %"class.hls::stream.0", align 512
  %index_stream_out_copy = alloca %"class.hls::stream.0", align 512
  %locate_stream_in_copy = alloca %"class.hls::stream.0", align 512
  %count_stream_in_copy = alloca %"class.hls::stream.0", align 512
  %0 = bitcast i32* %FP_DB to [153600 x i32]*
  %1 = bitcast i32* %hash_table to [907200 x i32]*
  call fastcc void @copy_in([153600 x i32]* %0, [153600 x i32]* %FP_DB_copy, [907200 x i32]* %1, [907200 x i32]* %hash_table_copy, %"class.hls::stream"* %complete_stream_in, %"class.hls::stream"* nonnull align 512 %complete_stream_in_copy, %"class.hls::stream.0"* %fp32_stream_out, %"class.hls::stream.0"* nonnull align 512 %fp32_stream_out_copy, %"class.hls::stream.0"* %haming_stream_in, %"class.hls::stream.0"* nonnull align 512 %haming_stream_in_copy, %"class.hls::stream.0"* %index_stream_out, %"class.hls::stream.0"* nonnull align 512 %index_stream_out_copy, %"class.hls::stream.0"* %locate_stream_in, %"class.hls::stream.0"* nonnull align 512 %locate_stream_in_copy, %"class.hls::stream.0"* %count_stream_in, %"class.hls::stream.0"* nonnull align 512 %count_stream_in_copy)
  ...
  call void @apatb_judge_index_set_1_hw(i32* %2, i32* %3, %"class.hls::stream"* %complete_stream_in_copy, %"class.hls::stream.0"* %fp32_stream_out_copy, %"class.hls::stream.0"* %haming_stream_in_copy, %"class.hls::stream.0"* %index_stream_out_copy, %"class.hls::stream.0"* %locate_stream_in_copy, %"class.hls::stream.0"* %count_stream_in_copy)
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.0"(%"class.hls::stream.0"* align 512 %15, %"class.hls::stream.0"* %14)
  ret void
}
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.0"(%"class.hls::stream.0"* %14, %"class.hls::stream.0"* align 512 %15)
  ret void
}

declare void @free(i8*) local_unnamed_addr

declare void @apatb_judge_index_set_1_hw(i32*, i32*, %"class.hls::stream"*, %"class.hls::stream.0"*, %"class.hls::stream.0"*, %"class.hls::stream.0"*, %"class.hls::stream.0"*, %"class.hls::stream.0"*)

define void @judge_index_set_1_hw_stub_wrapper(i32*, i32*, %"class.hls::stream"*, %"class.hls::stream.0"*, %"class.hls::stream.0"*, %"class.hls::stream.0"*, %"class.hls::stream.0"*, %"class.hls::stream.0"*) #7 {
entry:
  %8 = bitcast i32* %0 to [153600 x i32]*
  %9 = bitcast i32* %1 to [907200 x i32]*
  call void @copy_out([153600 x i32]* null, [153600 x i32]* %8, [907200 x i32]* null, [907200 x i32]* %9, %"class.hls::stream"* null, %"class.hls::stream"* %2, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %3, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %4, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %5, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %6, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %7)
  %10 = bitcast [153600 x i32]* %8 to i32*
  %11 = bitcast [907200 x i32]* %9 to i32*
  call void @judge_index_set_1_hw_stub(i32* %10, i32* %11, %"class.hls::stream"* %2, %"class.hls::stream.0"* %3, %"class.hls::stream.0"* %4, %"class.hls::stream.0"* %5, %"class.hls::stream.0"* %6, %"class.hls::stream.0"* %7)
  call void @copy_in([153600 x i32]* null, [153600 x i32]* %8, [907200 x i32]* null, [907200 x i32]* %9, %"class.hls::stream"* null, %"class.hls::stream"* %2, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %3, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %4, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %5, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %6, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %7)
  ret void
}

declare void @judge_index_set_1_hw_stub(i32*, i32*, %"class.hls::stream"*, %"class.hls::stream.0"*, %"class.hls::stream.0"*, %"class.hls::stream.0"*, %"class.hls::stream.0"*, %"class.hls::stream.0"*)
