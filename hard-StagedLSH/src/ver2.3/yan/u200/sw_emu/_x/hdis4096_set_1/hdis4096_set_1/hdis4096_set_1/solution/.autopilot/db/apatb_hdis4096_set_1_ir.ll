; ModuleID = '/home/nomoto/src/StagedLSH/hard-StagedLSH/src/ver2.3/yan/u200/sw_emu/_x/hdis4096_set_1/hdis4096_set_1/hdis4096_set_1/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_hdis4096_set_1_ir(i32* %query, %"class.hls::stream"* %complete_stream_in, %"class.hls::stream.6"* %fp32_stream_in, %"class.hls::stream.6"* %haming_stream_out) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_in([512 x i32]* %0, [512 x i32]* nonnull align 512 %query_copy, %"class.hls::stream"* %complete_stream_in, %"class.hls::stream"* nonnull align 512 %complete_stream_in_copy, %"class.hls::stream.6"* %fp32_stream_in, %"class.hls::stream.6"* nonnull align 512 %fp32_stream_in_copy, %"class.hls::stream.6"* %haming_stream_out, %"class.hls::stream.6"* nonnull align 512 %haming_stream_out_copy)
  %1 = getelementptr inbounds [512 x i32], [512 x i32]* %query_copy, i32 0, i32 0
  call void @apatb_hdis4096_set_1_hw(i32* %1, %"class.hls::stream"* %complete_stream_in_copy, %"class.hls::stream.6"* %fp32_stream_in_copy, %"class.hls::stream.6"* %haming_stream_out_copy)
  call fastcc void @copy_out([512 x i32]* %0, [512 x i32]* nonnull align 512 %query_copy, %"class.hls::stream"* %complete_stream_in, %"class.hls::stream"* nonnull align 512 %complete_stream_in_copy, %"class.hls::stream.6"* %fp32_stream_in, %"class.hls::stream.6"* nonnull align 512 %fp32_stream_in_copy, %"class.hls::stream.6"* %haming_stream_out, %"class.hls::stream.6"* nonnull align 512 %haming_stream_out_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in([512 x i32]* readonly, [512 x i32]* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out([512 x i32]*, [512 x i32]* noalias readonly align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512) unnamed_addr #6 {
entry:
...
declare void @apatb_hdis4096_set_1_hw(i32*, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*)

define void @hdis4096_set_1_hw_stub_wrapper(i32*, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*) #7 {
entry:
  %4 = bitcast i32* %0 to [512 x i32]*
  call void @copy_out([512 x i32]* null, [512 x i32]* %4, %"class.hls::stream"* null, %"class.hls::stream"* %1, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %2, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %3)
  %5 = bitcast [512 x i32]* %4 to i32*
  call void @hdis4096_set_1_hw_stub(i32* %5, %"class.hls::stream"* %1, %"class.hls::stream.6"* %2, %"class.hls::stream.6"* %3)
  call void @copy_in([512 x i32]* null, [512 x i32]* %4, %"class.hls::stream"* null, %"class.hls::stream"* %1, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %2, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %3)
  ret void
}

declare void @hdis4096_set_1_hw_stub(i32*, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*)
