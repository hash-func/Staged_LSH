; ModuleID = '/home/nomoto/src/StagedLSH/hard-StagedLSH/src/ver2.3/yan/u200/sw_emu/_x/hid_bound_set_1/hid_bound_set_1/hid_bound_set_1/solution/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

%"class.hls::stream.6" = type { %"struct.hls::axis" }
%"struct.hls::axis" = type { %struct.ap_uint, %struct.ap_uint.7, %struct.ap_uint.7, %struct.ap_uint.10, %struct.ap_uint.10, %struct.ap_uint.10, %struct.ap_uint.10 }
...
%struct.ssdm_int.9 = type { i4 }
%struct.ap_uint.10 = type { %struct.ap_int_base.11 }
%struct.ap_int_base.11 = type { %struct.ssdm_int.12 }
%struct.ssdm_int.12 = type { i1 }

; Function Attrs: noinline
define void @apatb_hid_bound_set_1_ir(i32* %flame, i32* %hash_table_pointer, i32* %FP_DB, i32* %hash_table, %"class.hls::stream.6"* %count_stream_out, %"class.hls::stream.6"* %locate_stream_out) local_unnamed_addr #0 {
entry:
  ...
  %count_stream_out_copy = alloca %"class.hls::stream.6", align 512
  %locate_stream_out_copy = alloca %"class.hls::stream.6", align 512
  ...
  call fastcc void @copy_in([12 x i32]* %0, [12 x i32]* nonnull align 512 %flame_copy, [32768 x i32]* %1, [32768 x i32]* %hash_table_pointer_copy, [153600 x i32]* %2, [153600 x i32]* %FP_DB_copy, [907200 x i32]* %3, [907200 x i32]* %hash_table_copy, %"class.hls::stream.6"* %count_stream_out, %"class.hls::stream.6"* nonnull align 512 %count_stream_out_copy, %"class.hls::stream.6"* %locate_stream_out, %"class.hls::stream.6"* nonnull align 512 %locate_stream_out_copy)
  ...
  call void @apatb_hid_bound_set_1_hw(i32* %4, i32* %5, i32* %6, i32* %7, %"class.hls::stream.6"* %count_stream_out_copy, %"class.hls::stream.6"* %locate_stream_out_copy)
...
; Function Attrs: noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream.6"(%"class.hls::stream.6"* noalias align 512, %"class.hls::stream.6"* noalias) unnamed_addr #4 {
entry:
...
; <label>:49:                                     ; preds = %46, %45, %41, %37
  ...
  %50 = bitcast %struct.ap_uint.10* %.0.326 to i8*
  %51 = call i1 @fpga_fifo_exist_1(i8* %50)
  br i1 %51, label %52, label %53

; <label>:52:                                     ; preds = %49
  call fastcc void @streamcpy_hls.p0struct.ap_uint.10(%struct.ap_uint.10* %.01.327, %struct.ap_uint.10* %.0.326)
  br label %64
...
; <label>:53:                                     ; preds = %49
  ...
  %54 = bitcast %struct.ap_int_base.11* %.0.3.028 to i8*
  %55 = call i1 @fpga_fifo_exist_1(i8* %54)
  br i1 %55, label %56, label %57

; <label>:56:                                     ; preds = %53
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.11(%struct.ap_int_base.11* %.01.3.029, %struct.ap_int_base.11* %.0.3.028)
  br label %64
...
; <label>:57:                                     ; preds = %53
  ...
  %58 = bitcast %struct.ssdm_int.12* %.0.3.0.030 to i8*
  %59 = call i1 @fpga_fifo_exist_1(i8* %58)
  br i1 %59, label %60, label %61

; <label>:60:                                     ; preds = %57
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.12(%struct.ssdm_int.12* %.01.3.0.031, %struct.ssdm_int.12* %.0.3.0.030)
  br label %64
...
; <label>:64:                                     ; preds = %61, %60, %56, %52
  ...
  %65 = bitcast %struct.ap_uint.10* %.0.434 to i8*
  %66 = call i1 @fpga_fifo_exist_1(i8* %65)
  br i1 %66, label %67, label %68

; <label>:67:                                     ; preds = %64
  call fastcc void @streamcpy_hls.p0struct.ap_uint.10(%struct.ap_uint.10* %.01.435, %struct.ap_uint.10* %.0.434)
  br label %79
...
; <label>:68:                                     ; preds = %64
  ...
  %69 = bitcast %struct.ap_int_base.11* %.0.4.036 to i8*
  %70 = call i1 @fpga_fifo_exist_1(i8* %69)
  br i1 %70, label %71, label %72

; <label>:71:                                     ; preds = %68
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.11(%struct.ap_int_base.11* %.01.4.037, %struct.ap_int_base.11* %.0.4.036)
  br label %79
...
; <label>:72:                                     ; preds = %68
  ...
  %73 = bitcast %struct.ssdm_int.12* %.0.4.0.038 to i8*
  %74 = call i1 @fpga_fifo_exist_1(i8* %73)
  br i1 %74, label %75, label %76

; <label>:75:                                     ; preds = %72
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.12(%struct.ssdm_int.12* %.01.4.0.039, %struct.ssdm_int.12* %.0.4.0.038)
  br label %79
...
; <label>:79:                                     ; preds = %76, %75, %71, %67
  ...
  %80 = bitcast %struct.ap_uint.10* %.0.542 to i8*
  %81 = call i1 @fpga_fifo_exist_1(i8* %80)
  br i1 %81, label %82, label %83

; <label>:82:                                     ; preds = %79
  call fastcc void @streamcpy_hls.p0struct.ap_uint.10(%struct.ap_uint.10* %.01.543, %struct.ap_uint.10* %.0.542)
  br label %94
...
; <label>:83:                                     ; preds = %79
  ...
  %84 = bitcast %struct.ap_int_base.11* %.0.5.044 to i8*
  %85 = call i1 @fpga_fifo_exist_1(i8* %84)
  br i1 %85, label %86, label %87

; <label>:86:                                     ; preds = %83
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.11(%struct.ap_int_base.11* %.01.5.045, %struct.ap_int_base.11* %.0.5.044)
  br label %94
...
; <label>:87:                                     ; preds = %83
  ...
  %88 = bitcast %struct.ssdm_int.12* %.0.5.0.046 to i8*
  %89 = call i1 @fpga_fifo_exist_1(i8* %88)
  br i1 %89, label %90, label %91

; <label>:90:                                     ; preds = %87
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.12(%struct.ssdm_int.12* %.01.5.0.047, %struct.ssdm_int.12* %.0.5.0.046)
  br label %94
...
; <label>:94:                                     ; preds = %91, %90, %86, %82
  ...
  %95 = bitcast %struct.ap_uint.10* %.0.650 to i8*
  %96 = call i1 @fpga_fifo_exist_1(i8* %95)
  br i1 %96, label %97, label %98

; <label>:97:                                     ; preds = %94
  call fastcc void @streamcpy_hls.p0struct.ap_uint.10(%struct.ap_uint.10* %.01.651, %struct.ap_uint.10* %.0.650)
  br label %ret
...
; <label>:98:                                     ; preds = %94
  ...
  %99 = bitcast %struct.ap_int_base.11* %.0.6.052 to i8*
  %100 = call i1 @fpga_fifo_exist_1(i8* %99)
  br i1 %100, label %101, label %102

; <label>:101:                                    ; preds = %98
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.11(%struct.ap_int_base.11* %.01.6.053, %struct.ap_int_base.11* %.0.6.052)
  br label %ret
...
; <label>:102:                                    ; preds = %98
  ...
  %103 = bitcast %struct.ssdm_int.12* %.0.6.0.054 to i8*
  %104 = call i1 @fpga_fifo_exist_1(i8* %103)
  br i1 %104, label %105, label %106

; <label>:105:                                    ; preds = %102
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.12(%struct.ssdm_int.12* %.01.6.0.055, %struct.ssdm_int.12* %.0.6.0.054)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream.6"(%"class.hls::stream.6"* noalias nocapture align 512, %"class.hls::stream.6"* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_uint.10(%struct.ap_uint.10* noalias nocapture, %struct.ap_uint.10* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_int_base.11(%struct.ap_int_base.11* noalias nocapture, %struct.ap_int_base.11* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ssdm_int.12(%struct.ssdm_int.12* noalias nocapture, %struct.ssdm_int.12* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out([12 x i32]*, [12 x i32]* noalias readonly align 512, [32768 x i32]*, [32768 x i32]* noalias readonly, [153600 x i32]*, [153600 x i32]* noalias readonly, [907200 x i32]*, [907200 x i32]* noalias readonly, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512) unnamed_addr #6 {
entry:
...
declare void @apatb_hid_bound_set_1_hw(i32*, i32*, i32*, i32*, %"class.hls::stream.6"*, %"class.hls::stream.6"*)

define void @hid_bound_set_1_hw_stub_wrapper(i32*, i32*, i32*, i32*, %"class.hls::stream.6"*, %"class.hls::stream.6"*) #7 {
entry:
  %6 = bitcast i32* %0 to [12 x i32]*
  %7 = bitcast i32* %1 to [32768 x i32]*
  %8 = bitcast i32* %2 to [153600 x i32]*
  %9 = bitcast i32* %3 to [907200 x i32]*
  call void @copy_out([12 x i32]* null, [12 x i32]* %6, [32768 x i32]* null, [32768 x i32]* %7, [153600 x i32]* null, [153600 x i32]* %8, [907200 x i32]* null, [907200 x i32]* %9, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %4, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %5)
  ...
  call void @hid_bound_set_1_hw_stub(i32* %10, i32* %11, i32* %12, i32* %13, %"class.hls::stream.6"* %4, %"class.hls::stream.6"* %5)
  call void @copy_in([12 x i32]* null, [12 x i32]* %6, [32768 x i32]* null, [32768 x i32]* %7, [153600 x i32]* null, [153600 x i32]* %8, [907200 x i32]* null, [907200 x i32]* %9, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %4, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %5)
  ret void
}

declare void @hid_bound_set_1_hw_stub(i32*, i32*, i32*, i32*, %"class.hls::stream.6"*, %"class.hls::stream.6"*)
