...
public:
    ...
    const unsigned int division_num )	
  {
	...
	mKernel_test        = clCreateKernel(Program, "test_bench",         &mErr);
    ...
    clEnqueueMigrateMemObjects(mQueue, 2, mConstBuf, 0, 0, nullptr,  nullptr);
  }
