; ModuleID = '/home/nomoto/src/StagedLSH/hard-StagedLSH/src/ver2.2/yan/u200/sw_emu/_x/hdis96_set_1/hdis96_set_1/hdis96_set_1/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_hdis96_set_1_ir(i32* %flame, %"class.hls::stream"* %top_stream_in, %"class.hls::stream"* %end_stream_in, %"class.hls::stream.6"* %flame96_stream_in1, %"class.hls::stream"* %count_stream_out, %"class.hls::stream"* %locate_stream_out) local_unnamed_addr #0 {
entry:
  %flame_copy = alloca [12 x i32], align 512
  %top_stream_in_copy = alloca %"class.hls::stream", align 512
  %end_stream_in_copy = alloca %"class.hls::stream", align 512
  %flame96_stream_in1_copy = alloca %"class.hls::stream.6", align 512
  %count_stream_out_copy = alloca %"class.hls::stream", align 512
  %locate_stream_out_copy = alloca %"class.hls::stream", align 512
  %0 = bitcast i32* %flame to [12 x i32]*
  call fastcc void @copy_in([12 x i32]* %0, [12 x i32]* nonnull align 512 %flame_copy, %"class.hls::stream"* %top_stream_in, %"class.hls::stream"* nonnull align 512 %top_stream_in_copy, %"class.hls::stream"* %end_stream_in, %"class.hls::stream"* nonnull align 512 %end_stream_in_copy, %"class.hls::stream.6"* %flame96_stream_in1, %"class.hls::stream.6"* nonnull align 512 %flame96_stream_in1_copy, %"class.hls::stream"* %count_stream_out, %"class.hls::stream"* nonnull align 512 %count_stream_out_copy, %"class.hls::stream"* %locate_stream_out, %"class.hls::stream"* nonnull align 512 %locate_stream_out_copy)
  %1 = getelementptr inbounds [12 x i32], [12 x i32]* %flame_copy, i32 0, i32 0
  call void @apatb_hdis96_set_1_hw(i32* %1, %"class.hls::stream"* %top_stream_in_copy, %"class.hls::stream"* %end_stream_in_copy, %"class.hls::stream.6"* %flame96_stream_in1_copy, %"class.hls::stream"* %count_stream_out_copy, %"class.hls::stream"* %locate_stream_out_copy)
  call fastcc void @copy_out([12 x i32]* %0, [12 x i32]* nonnull align 512 %flame_copy, %"class.hls::stream"* %top_stream_in, %"class.hls::stream"* nonnull align 512 %top_stream_in_copy, %"class.hls::stream"* %end_stream_in, %"class.hls::stream"* nonnull align 512 %end_stream_in_copy, %"class.hls::stream.6"* %flame96_stream_in1, %"class.hls::stream.6"* nonnull align 512 %flame96_stream_in1_copy, %"class.hls::stream"* %count_stream_out, %"class.hls::stream"* nonnull align 512 %count_stream_out_copy, %"class.hls::stream"* %locate_stream_out, %"class.hls::stream"* nonnull align 512 %locate_stream_out_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in([12 x i32]* readonly, [12 x i32]* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_uint.8(%struct.ap_uint.8* noalias nocapture align 512, %struct.ap_uint.8* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_int_base.9(%struct.ap_int_base.9* noalias nocapture align 512, %struct.ap_int_base.9* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ssdm_int.10(%struct.ssdm_int.10* noalias nocapture align 512, %struct.ssdm_int.10* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out([12 x i32]*, [12 x i32]* noalias readonly align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #6 {
entry:
...
declare void @apatb_hdis96_set_1_hw(i32*, %"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream"*, %"class.hls::stream"*)

define void @hdis96_set_1_hw_stub_wrapper(i32*, %"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream"*, %"class.hls::stream"*) #7 {
entry:
  %6 = bitcast i32* %0 to [12 x i32]*
  call void @copy_out([12 x i32]* null, [12 x i32]* %6, %"class.hls::stream"* null, %"class.hls::stream"* %1, %"class.hls::stream"* null, %"class.hls::stream"* %2, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %3, %"class.hls::stream"* null, %"class.hls::stream"* %4, %"class.hls::stream"* null, %"class.hls::stream"* %5)
  %7 = bitcast [12 x i32]* %6 to i32*
  call void @hdis96_set_1_hw_stub(i32* %7, %"class.hls::stream"* %1, %"class.hls::stream"* %2, %"class.hls::stream.6"* %3, %"class.hls::stream"* %4, %"class.hls::stream"* %5)
  call void @copy_in([12 x i32]* null, [12 x i32]* %6, %"class.hls::stream"* null, %"class.hls::stream"* %1, %"class.hls::stream"* null, %"class.hls::stream"* %2, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %3, %"class.hls::stream"* null, %"class.hls::stream"* %4, %"class.hls::stream"* null, %"class.hls::stream"* %5)
  ret void
}

declare void @hdis96_set_1_hw_stub(i32*, %"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream"*, %"class.hls::stream"*)
