; ModuleID = '/home/nomoto/src/StagedLSH/hard-StagedLSH/src/ver2.2/yan/u200/sw_emu/_x/determin/determin/determin/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_determin_ir(i32* %judge, i1 %trial_flag, i1 %qe_flag, %"class.hls::stream"* %index_stream_in1, %"class.hls::stream.6"* %complete_stream_out1_1, %"class.hls::stream.6"* %complete_stream_out1_2) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_in([4 x i32]* %0, [4 x i32]* nonnull align 512 %judge_copy, %"class.hls::stream"* %index_stream_in1, %"class.hls::stream"* nonnull align 512 %index_stream_in1_copy, %"class.hls::stream.6"* %complete_stream_out1_1, %"class.hls::stream.6"* nonnull align 512 %complete_stream_out1_1_copy, %"class.hls::stream.6"* %complete_stream_out1_2, %"class.hls::stream.6"* nonnull align 512 %complete_stream_out1_2_copy)
  %1 = getelementptr inbounds [4 x i32], [4 x i32]* %judge_copy, i32 0, i32 0
  call void @apatb_determin_hw(i32* %1, i1 %trial_flag, i1 %qe_flag, %"class.hls::stream"* %index_stream_in1_copy, %"class.hls::stream.6"* %complete_stream_out1_1_copy, %"class.hls::stream.6"* %complete_stream_out1_2_copy)
  call fastcc void @copy_out([4 x i32]* %0, [4 x i32]* nonnull align 512 %judge_copy, %"class.hls::stream"* %index_stream_in1, %"class.hls::stream"* nonnull align 512 %index_stream_in1_copy, %"class.hls::stream.6"* %complete_stream_out1_1, %"class.hls::stream.6"* nonnull align 512 %complete_stream_out1_1_copy, %"class.hls::stream.6"* %complete_stream_out1_2, %"class.hls::stream.6"* nonnull align 512 %complete_stream_out1_2_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in([4 x i32]* readonly, [4 x i32]* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out([4 x i32]*, [4 x i32]* noalias readonly align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512) unnamed_addr #6 {
entry:
...
declare void @apatb_determin_hw(i32*, i1, i1, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*)

define void @determin_hw_stub_wrapper(i32*, i1, i1, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*) #7 {
entry:
  %6 = bitcast i32* %0 to [4 x i32]*
  call void @copy_out([4 x i32]* null, [4 x i32]* %6, %"class.hls::stream"* null, %"class.hls::stream"* %3, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %4, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %5)
  %7 = bitcast [4 x i32]* %6 to i32*
  call void @determin_hw_stub(i32* %7, i1 %1, i1 %2, %"class.hls::stream"* %3, %"class.hls::stream.6"* %4, %"class.hls::stream.6"* %5)
  call void @copy_in([4 x i32]* null, [4 x i32]* %6, %"class.hls::stream"* null, %"class.hls::stream"* %3, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %4, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %5)
  ret void
}

declare void @determin_hw_stub(i32*, i1, i1, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*)
