; ModuleID = '/home/nomoto/src/StagedLSH/hard-StagedLSH/src/ver2.2/yan/u200/sw_emu/_x/hid_bound_set_1/hid_bound_set_1/hid_bound_set_1/solution/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

%"class.hls::stream.4" = type { %"struct.hls::axis" }
%"struct.hls::axis" = type { %struct.ap_uint, %struct.ap_uint.5, %struct.ap_uint.5, %struct.ap_uint.8, %struct.ap_uint.8, %struct.ap_uint.8, %struct.ap_uint.8 }
...
%"class.hls::stream.11" = type { %"struct.hls::axis.12" }
%"struct.hls::axis.12" = type { %struct.ap_uint.0, %struct.ap_uint.13, %struct.ap_uint.13, %struct.ap_uint.8, %struct.ap_uint.8, %struct.ap_uint.8, %struct.ap_uint.8 }
...
define void @apatb_hid_bound_set_1_ir(i32* %flame, i32* %hash_table_pointer, i32* %FP_DB, i32* %hash_table, %"class.hls::stream.4"* %top_stream_out_1, %"class.hls::stream.4"* %end_stream_out_1, %"class.hls::stream.11"* %flame96_stream_out) local_unnamed_addr #0 {
entry:
  ...
  %top_stream_out_1_copy = alloca %"class.hls::stream.4", align 512
  %end_stream_out_1_copy = alloca %"class.hls::stream.4", align 512
  %flame96_stream_out_copy = alloca %"class.hls::stream.11", align 512
  ...
  call fastcc void @copy_in([12 x i32]* %0, [12 x i32]* nonnull align 512 %flame_copy, [32768 x i32]* %1, [32768 x i32]* %hash_table_pointer_copy, [153600 x i32]* %2, [153600 x i32]* %FP_DB_copy, [907200 x i32]* %3, [907200 x i32]* %hash_table_copy, %"class.hls::stream.4"* %top_stream_out_1, %"class.hls::stream.4"* nonnull align 512 %top_stream_out_1_copy, %"class.hls::stream.4"* %end_stream_out_1, %"class.hls::stream.4"* nonnull align 512 %end_stream_out_1_copy, %"class.hls::stream.11"* %flame96_stream_out, %"class.hls::stream.11"* nonnull align 512 %flame96_stream_out_copy)
  ...
  call void @apatb_hid_bound_set_1_hw(i32* %4, i32* %5, i32* %6, i32* %7, %"class.hls::stream.4"* %top_stream_out_1_copy, %"class.hls::stream.4"* %end_stream_out_1_copy, %"class.hls::stream.11"* %flame96_stream_out_copy)
...
; Function Attrs: noinline
define internal fastcc void @copy_in([12 x i32]* readonly, [12 x i32]* noalias align 512, [32768 x i32]* readonly, [32768 x i32]* noalias, [153600 x i32]* readonly, [153600 x i32]* noalias, [907200 x i32]* readonly, [907200 x i32]* noalias, %"class.hls::stream.4"*, %"class.hls::stream.4"* noalias align 512, %"class.hls::stream.4"*, %"class.hls::stream.4"* noalias align 512, %"class.hls::stream.11"*, %"class.hls::stream.11"* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream.4"(%"class.hls::stream.4"* noalias align 512, %"class.hls::stream.4"* noalias) unnamed_addr #4 {
entry:
...
; <label>:19:                                     ; preds = %17, %16, %13, %10
  %.0.110 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 1
  %.01.111 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 1
...
; <label>:23:                                     ; preds = %19
  %.0.1.012 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 1, i32 0
  %.01.1.013 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 1, i32 0
...
; <label>:27:                                     ; preds = %23
  %.0.1.0.014 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 1, i32 0, i32 0
  %.01.1.0.015 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 1, i32 0, i32 0
...
; <label>:31:                                     ; preds = %27
  %.01.1.0.0.017.gep59 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
  %32 = bitcast i4* %.01.1.0.0.017.gep59 to i8*
  %.0.1.0.0.016.gep60 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
...
; <label>:34:                                     ; preds = %31, %30, %26, %22
  %.0.218 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 2
  %.01.219 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 2
...
; <label>:38:                                     ; preds = %34
  %.0.2.020 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 2, i32 0
  %.01.2.021 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 2, i32 0
...
; <label>:42:                                     ; preds = %38
  %.0.2.0.022 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 2, i32 0, i32 0
  %.01.2.0.023 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 2, i32 0, i32 0
...
; <label>:46:                                     ; preds = %42
  %.01.2.0.0.025.gep61 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 2, i32 0, i32 0, i32 0
  %47 = bitcast i4* %.01.2.0.0.025.gep61 to i8*
  %.0.2.0.0.024.gep62 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 2, i32 0, i32 0, i32 0
...
; <label>:49:                                     ; preds = %46, %45, %41, %37
  %.0.326 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 3
  %.01.327 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 3
...
; <label>:53:                                     ; preds = %49
  %.0.3.028 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 3, i32 0
  %.01.3.029 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 3, i32 0
...
; <label>:57:                                     ; preds = %53
  %.0.3.0.030 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 3, i32 0, i32 0
  %.01.3.0.031 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 3, i32 0, i32 0
...
; <label>:61:                                     ; preds = %57
  %.01.3.0.0.033.gep63 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 3, i32 0, i32 0, i32 0
  %62 = bitcast i1* %.01.3.0.0.033.gep63 to i8*
  %.0.3.0.0.032.gep64 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 3, i32 0, i32 0, i32 0
...
; <label>:64:                                     ; preds = %61, %60, %56, %52
  %.0.434 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 4
  %.01.435 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 4
...
; <label>:68:                                     ; preds = %64
  %.0.4.036 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 4, i32 0
  %.01.4.037 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 4, i32 0
...
; <label>:72:                                     ; preds = %68
  %.0.4.0.038 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 4, i32 0, i32 0
  %.01.4.0.039 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 4, i32 0, i32 0
...
; <label>:76:                                     ; preds = %72
  %.01.4.0.0.041.gep65 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 4, i32 0, i32 0, i32 0
  %77 = bitcast i1* %.01.4.0.0.041.gep65 to i8*
  %.0.4.0.0.040.gep66 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 4, i32 0, i32 0, i32 0
...
; <label>:79:                                     ; preds = %76, %75, %71, %67
  %.0.542 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 5
  %.01.543 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 5
...
; <label>:83:                                     ; preds = %79
  %.0.5.044 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 5, i32 0
  %.01.5.045 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 5, i32 0
...
; <label>:87:                                     ; preds = %83
  %.0.5.0.046 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 5, i32 0, i32 0
  %.01.5.0.047 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 5, i32 0, i32 0
...
; <label>:91:                                     ; preds = %87
  %.01.5.0.0.049.gep67 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 5, i32 0, i32 0, i32 0
  %92 = bitcast i1* %.01.5.0.0.049.gep67 to i8*
  %.0.5.0.0.048.gep68 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 5, i32 0, i32 0, i32 0
...
; <label>:94:                                     ; preds = %91, %90, %86, %82
  %.0.650 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 6
  %.01.651 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 6
...
; <label>:98:                                     ; preds = %94
  %.0.6.052 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 6, i32 0
  %.01.6.053 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 6, i32 0
...
; <label>:102:                                    ; preds = %98
  %.0.6.0.054 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 6, i32 0, i32 0
  %.01.6.0.055 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 6, i32 0, i32 0
...
; <label>:106:                                    ; preds = %102
  %.01.6.0.0.057.gep69 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %0, i32 0, i32 0, i32 6, i32 0, i32 0, i32 0
  %107 = bitcast i1* %.01.6.0.0.057.gep69 to i8*
  %.0.6.0.0.056.gep70 = getelementptr %"class.hls::stream.4", %"class.hls::stream.4"* %1, i32 0, i32 0, i32 6, i32 0, i32 0, i32 0
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream.4"(%"class.hls::stream.4"* noalias nocapture align 512, %"class.hls::stream.4"* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream.11"(%"class.hls::stream.11"* noalias align 512, %"class.hls::stream.11"* noalias) unnamed_addr #4 {
entry:
...
; <label>:31:                                     ; preds = %27
  %.01.1.0.0.017.gep59 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
  %32 = bitcast i12* %.01.1.0.0.017.gep59 to i8*
  %.0.1.0.0.016.gep60 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
  %33 = bitcast i12* %.0.1.0.0.016.gep60 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %32, i8* align 1 %33, i64 2, i1 false)
  br label %34

; <label>:34:                                     ; preds = %31, %30, %26, %22
  %.0.218 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 2
  %.01.219 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 2
...
; <label>:38:                                     ; preds = %34
  %.0.2.020 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 2, i32 0
  %.01.2.021 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 2, i32 0
...
; <label>:42:                                     ; preds = %38
  %.0.2.0.022 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 2, i32 0, i32 0
  %.01.2.0.023 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 2, i32 0, i32 0
...
; <label>:46:                                     ; preds = %42
  %.01.2.0.0.025.gep61 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 2, i32 0, i32 0, i32 0
  %47 = bitcast i12* %.01.2.0.0.025.gep61 to i8*
  %.0.2.0.0.024.gep62 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 2, i32 0, i32 0, i32 0
  %48 = bitcast i12* %.0.2.0.0.024.gep62 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %47, i8* align 1 %48, i64 2, i1 false)
  br label %49

; <label>:49:                                     ; preds = %46, %45, %41, %37
  %.0.326 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 3
  %.01.327 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 3
  %50 = bitcast %struct.ap_uint.8* %.0.326 to i8*
  %51 = call i1 @fpga_fifo_exist_1(i8* %50)
  br i1 %51, label %52, label %53
...
; <label>:53:                                     ; preds = %49
  %.0.3.028 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 3, i32 0
  %.01.3.029 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 3, i32 0
  %54 = bitcast %struct.ap_int_base.9* %.0.3.028 to i8*
  %55 = call i1 @fpga_fifo_exist_1(i8* %54)
  br i1 %55, label %56, label %57
...
; <label>:57:                                     ; preds = %53
  %.0.3.0.030 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 3, i32 0, i32 0
  %.01.3.0.031 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 3, i32 0, i32 0
  %58 = bitcast %struct.ssdm_int.10* %.0.3.0.030 to i8*
  %59 = call i1 @fpga_fifo_exist_1(i8* %58)
  br i1 %59, label %60, label %61
...
; <label>:61:                                     ; preds = %57
  %.01.3.0.0.033.gep63 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 3, i32 0, i32 0, i32 0
  %62 = bitcast i1* %.01.3.0.0.033.gep63 to i8*
  %.0.3.0.0.032.gep64 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 3, i32 0, i32 0, i32 0
  %63 = bitcast i1* %.0.3.0.0.032.gep64 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %62, i8* align 1 %63, i64 1, i1 false)
  br label %64

; <label>:64:                                     ; preds = %61, %60, %56, %52
  %.0.434 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 4
  %.01.435 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 4
  %65 = bitcast %struct.ap_uint.8* %.0.434 to i8*
  %66 = call i1 @fpga_fifo_exist_1(i8* %65)
  br i1 %66, label %67, label %68
...
; <label>:68:                                     ; preds = %64
  %.0.4.036 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 4, i32 0
  %.01.4.037 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 4, i32 0
  %69 = bitcast %struct.ap_int_base.9* %.0.4.036 to i8*
  %70 = call i1 @fpga_fifo_exist_1(i8* %69)
  br i1 %70, label %71, label %72
...
; <label>:72:                                     ; preds = %68
  %.0.4.0.038 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 4, i32 0, i32 0
  %.01.4.0.039 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 4, i32 0, i32 0
  %73 = bitcast %struct.ssdm_int.10* %.0.4.0.038 to i8*
  %74 = call i1 @fpga_fifo_exist_1(i8* %73)
  br i1 %74, label %75, label %76
...
; <label>:76:                                     ; preds = %72
  %.01.4.0.0.041.gep65 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 4, i32 0, i32 0, i32 0
  %77 = bitcast i1* %.01.4.0.0.041.gep65 to i8*
  %.0.4.0.0.040.gep66 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 4, i32 0, i32 0, i32 0
  %78 = bitcast i1* %.0.4.0.0.040.gep66 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %77, i8* align 1 %78, i64 1, i1 false)
  br label %79

; <label>:79:                                     ; preds = %76, %75, %71, %67
  %.0.542 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 5
  %.01.543 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 5
  %80 = bitcast %struct.ap_uint.8* %.0.542 to i8*
  %81 = call i1 @fpga_fifo_exist_1(i8* %80)
  br i1 %81, label %82, label %83
...
; <label>:83:                                     ; preds = %79
  %.0.5.044 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 5, i32 0
  %.01.5.045 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 5, i32 0
  %84 = bitcast %struct.ap_int_base.9* %.0.5.044 to i8*
  %85 = call i1 @fpga_fifo_exist_1(i8* %84)
  br i1 %85, label %86, label %87
...
; <label>:87:                                     ; preds = %83
  %.0.5.0.046 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 5, i32 0, i32 0
  %.01.5.0.047 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 5, i32 0, i32 0
  %88 = bitcast %struct.ssdm_int.10* %.0.5.0.046 to i8*
  %89 = call i1 @fpga_fifo_exist_1(i8* %88)
  br i1 %89, label %90, label %91
...
; <label>:91:                                     ; preds = %87
  %.01.5.0.0.049.gep67 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 5, i32 0, i32 0, i32 0
  %92 = bitcast i1* %.01.5.0.0.049.gep67 to i8*
  %.0.5.0.0.048.gep68 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 5, i32 0, i32 0, i32 0
  %93 = bitcast i1* %.0.5.0.0.048.gep68 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %92, i8* align 1 %93, i64 1, i1 false)
  br label %94

; <label>:94:                                     ; preds = %91, %90, %86, %82
  %.0.650 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 6
  %.01.651 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 6
  %95 = bitcast %struct.ap_uint.8* %.0.650 to i8*
  %96 = call i1 @fpga_fifo_exist_1(i8* %95)
  br i1 %96, label %97, label %98
...
; <label>:98:                                     ; preds = %94
  %.0.6.052 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 6, i32 0
  %.01.6.053 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 6, i32 0
  %99 = bitcast %struct.ap_int_base.9* %.0.6.052 to i8*
  %100 = call i1 @fpga_fifo_exist_1(i8* %99)
  br i1 %100, label %101, label %102
...
; <label>:102:                                    ; preds = %98
  %.0.6.0.054 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 6, i32 0, i32 0
  %.01.6.0.055 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 6, i32 0, i32 0
  %103 = bitcast %struct.ssdm_int.10* %.0.6.0.054 to i8*
  %104 = call i1 @fpga_fifo_exist_1(i8* %103)
  br i1 %104, label %105, label %106
...
; <label>:106:                                    ; preds = %102
  %.01.6.0.0.057.gep69 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %0, i32 0, i32 0, i32 6, i32 0, i32 0, i32 0
  %107 = bitcast i1* %.01.6.0.0.057.gep69 to i8*
  %.0.6.0.0.056.gep70 = getelementptr %"class.hls::stream.11", %"class.hls::stream.11"* %1, i32 0, i32 0, i32 6, i32 0, i32 0, i32 0
  %108 = bitcast i1* %.0.6.0.0.056.gep70 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %107, i8* align 1 %108, i64 1, i1 false)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream.11"(%"class.hls::stream.11"* noalias nocapture align 512, %"class.hls::stream.11"* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out([12 x i32]*, [12 x i32]* noalias readonly align 512, [32768 x i32]*, [32768 x i32]* noalias readonly, [153600 x i32]*, [153600 x i32]* noalias readonly, [907200 x i32]*, [907200 x i32]* noalias readonly, %"class.hls::stream.4"*, %"class.hls::stream.4"* noalias align 512, %"class.hls::stream.4"*, %"class.hls::stream.4"* noalias align 512, %"class.hls::stream.11"*, %"class.hls::stream.11"* noalias align 512) unnamed_addr #6 {
entry:
...
declare void @apatb_hid_bound_set_1_hw(i32*, i32*, i32*, i32*, %"class.hls::stream.4"*, %"class.hls::stream.4"*, %"class.hls::stream.11"*)

define void @hid_bound_set_1_hw_stub_wrapper(i32*, i32*, i32*, i32*, %"class.hls::stream.4"*, %"class.hls::stream.4"*, %"class.hls::stream.11"*) #7 {
entry:
  %7 = bitcast i32* %0 to [12 x i32]*
  %8 = bitcast i32* %1 to [32768 x i32]*
  %9 = bitcast i32* %2 to [153600 x i32]*
  %10 = bitcast i32* %3 to [907200 x i32]*
  call void @copy_out([12 x i32]* null, [12 x i32]* %7, [32768 x i32]* null, [32768 x i32]* %8, [153600 x i32]* null, [153600 x i32]* %9, [907200 x i32]* null, [907200 x i32]* %10, %"class.hls::stream.4"* null, %"class.hls::stream.4"* %4, %"class.hls::stream.4"* null, %"class.hls::stream.4"* %5, %"class.hls::stream.11"* null, %"class.hls::stream.11"* %6)
  ...
  call void @hid_bound_set_1_hw_stub(i32* %11, i32* %12, i32* %13, i32* %14, %"class.hls::stream.4"* %4, %"class.hls::stream.4"* %5, %"class.hls::stream.11"* %6)
  call void @copy_in([12 x i32]* null, [12 x i32]* %7, [32768 x i32]* null, [32768 x i32]* %8, [153600 x i32]* null, [153600 x i32]* %9, [907200 x i32]* null, [907200 x i32]* %10, %"class.hls::stream.4"* null, %"class.hls::stream.4"* %4, %"class.hls::stream.4"* null, %"class.hls::stream.4"* %5, %"class.hls::stream.11"* null, %"class.hls::stream.11"* %6)
  ret void
}

declare void @hid_bound_set_1_hw_stub(i32*, i32*, i32*, i32*, %"class.hls::stream.4"*, %"class.hls::stream.4"*, %"class.hls::stream.11"*)
