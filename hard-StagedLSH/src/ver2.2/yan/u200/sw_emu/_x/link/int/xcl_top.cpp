...
void hid_bound_set_1(size_t flame, size_t hash_table_pointer, size_t FP_DB, size_t hash_table, size_t top_stream_out_1, size_t end_stream_out_1, size_t flame96_stream_out);
...
void __stub____xlnx_cl_hid_bound_set_1(char **argv) {
  ...
  size_t flame96_stream_out = *((size_t*)args[6+1]);
 //  pthread_mutex_lock(&__xlnx_cl_hid_bound_set_1_mutex);
  hid_bound_set_1(flame, hash_table_pointer, FP_DB, hash_table, top_stream_out_1, end_stream_out_1, flame96_stream_out);
...
__XLNX_DEFINE_STREAM_FUNCS__(hdis96_set_1,hlsaxisapuint32,__xlnx_cl_struct_type_5) 

typedef hls::axis<ap_uint<32>, 0, 0, 0> __xlnx_cl_struct_type_6;
__XLNX_DEFINE_STREAM_FUNCS__(hid_bound_set_1,hlsaxisapuint32,__xlnx_cl_struct_type_6) 

typedef hls::axis<ap_uint<32>, 0, 0, 0> __xlnx_cl_struct_type_7;
__XLNX_DEFINE_STREAM_FUNCS__(judge_index_set_1,hlsaxisapuint32,__xlnx_cl_struct_type_7) 

typedef hls::axis<ap_uint<96>, 0, 0, 0> __xlnx_cl_struct_type_8;
__XLNX_DEFINE_STREAM_FUNCS__(hdis96_set_1,hlsaxisapuint96,__xlnx_cl_struct_type_8) 

typedef hls::axis<ap_uint<96>, 0, 0, 0> __xlnx_cl_struct_type_9;
__XLNX_DEFINE_STREAM_FUNCS__(hid_bound_set_1,hlsaxisapuint96,__xlnx_cl_struct_type_9) 
}
