...
open_project judge_index_set_1
set_top judge_index_set_1
# v++ -g, -D, -I, --advanced.prop kernel.judge_index_set_1.kernel_flags
add_files "/home/nomoto/src/StagedLSH/hard-StagedLSH/src/best_src_2/self/yan/src/kernel/serch_module_set_1/judge_index_set_1.cpp" -cflags " -g -I /home/nomoto/src/StagedLSH/hard-StagedLSH/src/best_src_2/self/yan/src/kernel "
...
config_export -format ip_catalog -ipname judge_index_set_1
