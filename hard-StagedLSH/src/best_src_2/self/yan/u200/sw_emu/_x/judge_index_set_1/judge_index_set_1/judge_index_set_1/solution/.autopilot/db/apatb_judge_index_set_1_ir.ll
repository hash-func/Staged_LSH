; ModuleID = '/home/nomoto/src/StagedLSH/hard-StagedLSH/src/best_src_2/self/yan/u200/sw_emu/_x/judge_index_set_1/judge_index_set_1/judge_index_set_1/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
%"struct.hls::axis" = type { %struct.ap_uint.3, %struct.ap_uint.6, %struct.ap_uint.6, %struct.ap_uint.9, %struct.ap_uint.9, %struct.ap_uint.9, %struct.ap_uint.9 }
...
%struct.ssdm_int.8 = type { i4 }
%struct.ap_uint.9 = type { %struct.ap_int_base.10 }
%struct.ap_int_base.10 = type { %struct.ssdm_int.11 }
%struct.ssdm_int.11 = type { i1 }

; Function Attrs: noinline
define void @apatb_judge_index_set_1_ir(%struct.ap_uint* %FP_DB, i32* %hash_table, %struct.ap_uint* %query, i32* %judge, %"class.hls::stream"* %locate_stream_in, %"class.hls::stream"* %count_stream_in) local_unnamed_addr #0 {
entry:
  %malloccall = tail call i8* @malloc(i64 9830400)
  %FP_DB_copy = bitcast i8* %malloccall to [153600 x %struct.ap_uint]*
  ...
  %query_copy = bitcast i8* %malloccall2 to [512 x %struct.ap_uint]*
  %judge_copy = alloca [4 x i32], align 512
  %locate_stream_in_copy = alloca %"class.hls::stream", align 512
  %count_stream_in_copy = alloca %"class.hls::stream", align 512
  %0 = bitcast %struct.ap_uint* %FP_DB to [153600 x %struct.ap_uint]*
  %1 = bitcast i32* %hash_table to [907200 x i32]*
  %2 = bitcast %struct.ap_uint* %query to [512 x %struct.ap_uint]*
  %3 = bitcast i32* %judge to [4 x i32]*
  call fastcc void @copy_in([153600 x %struct.ap_uint]* %0, [153600 x %struct.ap_uint]* %FP_DB_copy, [907200 x i32]* %1, [907200 x i32]* %hash_table_copy, [512 x %struct.ap_uint]* %2, [512 x %struct.ap_uint]* %query_copy, [4 x i32]* %3, [4 x i32]* nonnull align 512 %judge_copy, %"class.hls::stream"* %locate_stream_in, %"class.hls::stream"* nonnull align 512 %locate_stream_in_copy, %"class.hls::stream"* %count_stream_in, %"class.hls::stream"* nonnull align 512 %count_stream_in_copy)
  %4 = getelementptr inbounds [153600 x %struct.ap_uint], [153600 x %struct.ap_uint]* %FP_DB_copy, i32 0, i32 0
  %5 = getelementptr inbounds [907200 x i32], [907200 x i32]* %hash_table_copy, i32 0, i32 0
  %6 = getelementptr inbounds [512 x %struct.ap_uint], [512 x %struct.ap_uint]* %query_copy, i32 0, i32 0
  %7 = getelementptr inbounds [4 x i32], [4 x i32]* %judge_copy, i32 0, i32 0
  call void @apatb_judge_index_set_1_hw(%struct.ap_uint* %4, i32* %5, %struct.ap_uint* %6, i32* %7, %"class.hls::stream"* %locate_stream_in_copy, %"class.hls::stream"* %count_stream_in_copy)
  call fastcc void @copy_out([153600 x %struct.ap_uint]* %0, [153600 x %struct.ap_uint]* %FP_DB_copy, [907200 x i32]* %1, [907200 x i32]* %hash_table_copy, [512 x %struct.ap_uint]* %2, [512 x %struct.ap_uint]* %query_copy, [4 x i32]* %3, [4 x i32]* nonnull align 512 %judge_copy, %"class.hls::stream"* %locate_stream_in, %"class.hls::stream"* nonnull align 512 %locate_stream_in_copy, %"class.hls::stream"* %count_stream_in, %"class.hls::stream"* nonnull align 512 %count_stream_in_copy)
...
; Function Attrs: noinline
define internal fastcc void @copy_in([153600 x %struct.ap_uint]*, [153600 x %struct.ap_uint]* noalias, [907200 x i32]* readonly, [907200 x i32]* noalias, [512 x %struct.ap_uint]*, [512 x %struct.ap_uint]* noalias, [4 x i32]* readonly, [4 x i32]* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #1 {
entry:
  call fastcc void @onebyonecpy_hls.p0a153600struct.ap_uint([153600 x %struct.ap_uint]* %1, [153600 x %struct.ap_uint]* %0)
  call fastcc void @onebyonecpy_hls.p0a907200i32([907200 x i32]* %3, [907200 x i32]* %2)
  call fastcc void @onebyonecpy_hls.p0a512struct.ap_uint([512 x %struct.ap_uint]* %5, [512 x %struct.ap_uint]* %4)
  call fastcc void @onebyonecpy_hls.p0a4i32([4 x i32]* align 512 %7, [4 x i32]* %6)
...
; Function Attrs: noinline
define internal fastcc void @onebyonecpy_hls.p0a153600struct.ap_uint([153600 x %struct.ap_uint]* noalias, [153600 x %struct.ap_uint]* noalias) unnamed_addr #2 {
entry:
  %2 = icmp eq [153600 x %struct.ap_uint]* %0, null
  %3 = icmp eq [153600 x %struct.ap_uint]* %1, null
  %4 = or i1 %2, %3
...
for.loop:                                         ; preds = %for.loop.head, %copy
  ...
  %dst.addr = getelementptr [153600 x %struct.ap_uint], [153600 x %struct.ap_uint]* %0, i64 0, i64 %for.loop.idx9
  %src.addr = getelementptr [153600 x %struct.ap_uint], [153600 x %struct.ap_uint]* %1, i64 0, i64 %for.loop.idx9
...
; <label>:8:                                      ; preds = %for.loop
  %src.addr.01 = getelementptr [153600 x %struct.ap_uint], [153600 x %struct.ap_uint]* %1, i64 0, i64 %for.loop.idx9, i32 0
  %dst.addr.02 = getelementptr [153600 x %struct.ap_uint], [153600 x %struct.ap_uint]* %0, i64 0, i64 %for.loop.idx9, i32 0
...
; <label>:12:                                     ; preds = %8
  %src.addr.0.03 = getelementptr [153600 x %struct.ap_uint], [153600 x %struct.ap_uint]* %1, i64 0, i64 %for.loop.idx9, i32 0, i32 0
  %dst.addr.0.04 = getelementptr [153600 x %struct.ap_uint], [153600 x %struct.ap_uint]* %0, i64 0, i64 %for.loop.idx9, i32 0, i32 0
...
; <label>:16:                                     ; preds = %12
  %dst.addr.0.0.06.gep7 = getelementptr [153600 x %struct.ap_uint], [153600 x %struct.ap_uint]* %0, i64 0, i64 %for.loop.idx9, i32 0, i32 0, i32 0
  %17 = bitcast i512* %dst.addr.0.0.06.gep7 to i8*
  %src.addr.0.0.05.gep8 = getelementptr [153600 x %struct.ap_uint], [153600 x %struct.ap_uint]* %1, i64 0, i64 %for.loop.idx9, i32 0, i32 0, i32 0
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a907200i32([907200 x i32]* noalias, [907200 x i32]* noalias readonly) unnamed_addr #5 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @onebyonecpy_hls.p0a512struct.ap_uint([512 x %struct.ap_uint]* noalias, [512 x %struct.ap_uint]* noalias) unnamed_addr #2 {
entry:
  %2 = icmp eq [512 x %struct.ap_uint]* %0, null
  %3 = icmp eq [512 x %struct.ap_uint]* %1, null
  %4 = or i1 %2, %3
  br i1 %4, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop.head, %copy
  %for.loop.idx9 = phi i64 [ 0, %copy ], [ %for.loop.idx.next, %for.loop.head ]
  %dst.addr = getelementptr [512 x %struct.ap_uint], [512 x %struct.ap_uint]* %0, i64 0, i64 %for.loop.idx9
  %src.addr = getelementptr [512 x %struct.ap_uint], [512 x %struct.ap_uint]* %1, i64 0, i64 %for.loop.idx9
  %5 = bitcast %struct.ap_uint* %src.addr to i8*
  %6 = call i1 @fpga_fifo_exist_64(i8* %5)
  br i1 %6, label %7, label %8
...
; <label>:8:                                      ; preds = %for.loop
  %src.addr.01 = getelementptr [512 x %struct.ap_uint], [512 x %struct.ap_uint]* %1, i64 0, i64 %for.loop.idx9, i32 0
  %dst.addr.02 = getelementptr [512 x %struct.ap_uint], [512 x %struct.ap_uint]* %0, i64 0, i64 %for.loop.idx9, i32 0
  %9 = bitcast %struct.ap_int_base* %src.addr.01 to i8*
  %10 = call i1 @fpga_fifo_exist_64(i8* %9)
  br i1 %10, label %11, label %12
...
; <label>:12:                                     ; preds = %8
  %src.addr.0.03 = getelementptr [512 x %struct.ap_uint], [512 x %struct.ap_uint]* %1, i64 0, i64 %for.loop.idx9, i32 0, i32 0
  %dst.addr.0.04 = getelementptr [512 x %struct.ap_uint], [512 x %struct.ap_uint]* %0, i64 0, i64 %for.loop.idx9, i32 0, i32 0
  %13 = bitcast %struct.ssdm_int* %src.addr.0.03 to i8*
  %14 = call i1 @fpga_fifo_exist_64(i8* %13)
  br i1 %14, label %15, label %16
...
; <label>:16:                                     ; preds = %12
  %dst.addr.0.0.06.gep7 = getelementptr [512 x %struct.ap_uint], [512 x %struct.ap_uint]* %0, i64 0, i64 %for.loop.idx9, i32 0, i32 0, i32 0
  %17 = bitcast i512* %dst.addr.0.0.06.gep7 to i8*
  %src.addr.0.0.05.gep8 = getelementptr [512 x %struct.ap_uint], [512 x %struct.ap_uint]* %1, i64 0, i64 %for.loop.idx9, i32 0, i32 0, i32 0
  %18 = bitcast i512* %src.addr.0.0.05.gep8 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %17, i8* align 1 %18, i64 64, i1 false)
  br label %for.loop.head
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a4i32([4 x i32]* noalias align 512, [4 x i32]* noalias readonly) unnamed_addr #5 {
entry:
...
; <label>:19:                                     ; preds = %17, %16, %13, %10
  ...
  %20 = bitcast %struct.ap_uint.6* %.0.110 to i8*
  %21 = call i1 @fpga_fifo_exist_1(i8* %20)
  br i1 %21, label %22, label %23

; <label>:22:                                     ; preds = %19
  call fastcc void @streamcpy_hls.p0struct.ap_uint.6(%struct.ap_uint.6* %.01.111, %struct.ap_uint.6* %.0.110)
  br label %34
...
; <label>:23:                                     ; preds = %19
  ...
  %24 = bitcast %struct.ap_int_base.7* %.0.1.012 to i8*
  %25 = call i1 @fpga_fifo_exist_1(i8* %24)
  br i1 %25, label %26, label %27

; <label>:26:                                     ; preds = %23
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.7(%struct.ap_int_base.7* %.01.1.013, %struct.ap_int_base.7* %.0.1.012)
  br label %34
...
; <label>:27:                                     ; preds = %23
  ...
  %28 = bitcast %struct.ssdm_int.8* %.0.1.0.014 to i8*
  %29 = call i1 @fpga_fifo_exist_1(i8* %28)
  br i1 %29, label %30, label %31

; <label>:30:                                     ; preds = %27
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.8(%struct.ssdm_int.8* %.01.1.0.015, %struct.ssdm_int.8* %.0.1.0.014)
  br label %34
...
; <label>:34:                                     ; preds = %31, %30, %26, %22
  ...
  %35 = bitcast %struct.ap_uint.6* %.0.218 to i8*
  %36 = call i1 @fpga_fifo_exist_1(i8* %35)
  br i1 %36, label %37, label %38

; <label>:37:                                     ; preds = %34
  call fastcc void @streamcpy_hls.p0struct.ap_uint.6(%struct.ap_uint.6* %.01.219, %struct.ap_uint.6* %.0.218)
  br label %49
...
; <label>:38:                                     ; preds = %34
  ...
  %39 = bitcast %struct.ap_int_base.7* %.0.2.020 to i8*
  %40 = call i1 @fpga_fifo_exist_1(i8* %39)
  br i1 %40, label %41, label %42

; <label>:41:                                     ; preds = %38
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.7(%struct.ap_int_base.7* %.01.2.021, %struct.ap_int_base.7* %.0.2.020)
  br label %49
...
; <label>:42:                                     ; preds = %38
  ...
  %43 = bitcast %struct.ssdm_int.8* %.0.2.0.022 to i8*
  %44 = call i1 @fpga_fifo_exist_1(i8* %43)
  br i1 %44, label %45, label %46

; <label>:45:                                     ; preds = %42
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.8(%struct.ssdm_int.8* %.01.2.0.023, %struct.ssdm_int.8* %.0.2.0.022)
  br label %49
...
; <label>:49:                                     ; preds = %46, %45, %41, %37
  ...
  %50 = bitcast %struct.ap_uint.9* %.0.326 to i8*
  %51 = call i1 @fpga_fifo_exist_1(i8* %50)
  br i1 %51, label %52, label %53

; <label>:52:                                     ; preds = %49
  call fastcc void @streamcpy_hls.p0struct.ap_uint.9(%struct.ap_uint.9* %.01.327, %struct.ap_uint.9* %.0.326)
  br label %64
...
; <label>:53:                                     ; preds = %49
  ...
  %54 = bitcast %struct.ap_int_base.10* %.0.3.028 to i8*
  %55 = call i1 @fpga_fifo_exist_1(i8* %54)
  br i1 %55, label %56, label %57

; <label>:56:                                     ; preds = %53
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.10(%struct.ap_int_base.10* %.01.3.029, %struct.ap_int_base.10* %.0.3.028)
  br label %64
...
; <label>:57:                                     ; preds = %53
  ...
  %58 = bitcast %struct.ssdm_int.11* %.0.3.0.030 to i8*
  %59 = call i1 @fpga_fifo_exist_1(i8* %58)
  br i1 %59, label %60, label %61

; <label>:60:                                     ; preds = %57
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.11(%struct.ssdm_int.11* %.01.3.0.031, %struct.ssdm_int.11* %.0.3.0.030)
  br label %64
...
; <label>:64:                                     ; preds = %61, %60, %56, %52
  ...
  %65 = bitcast %struct.ap_uint.9* %.0.434 to i8*
  %66 = call i1 @fpga_fifo_exist_1(i8* %65)
  br i1 %66, label %67, label %68

; <label>:67:                                     ; preds = %64
  call fastcc void @streamcpy_hls.p0struct.ap_uint.9(%struct.ap_uint.9* %.01.435, %struct.ap_uint.9* %.0.434)
  br label %79
...
; <label>:68:                                     ; preds = %64
  ...
  %69 = bitcast %struct.ap_int_base.10* %.0.4.036 to i8*
  %70 = call i1 @fpga_fifo_exist_1(i8* %69)
  br i1 %70, label %71, label %72

; <label>:71:                                     ; preds = %68
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.10(%struct.ap_int_base.10* %.01.4.037, %struct.ap_int_base.10* %.0.4.036)
  br label %79
...
; <label>:72:                                     ; preds = %68
  ...
  %73 = bitcast %struct.ssdm_int.11* %.0.4.0.038 to i8*
  %74 = call i1 @fpga_fifo_exist_1(i8* %73)
  br i1 %74, label %75, label %76

; <label>:75:                                     ; preds = %72
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.11(%struct.ssdm_int.11* %.01.4.0.039, %struct.ssdm_int.11* %.0.4.0.038)
  br label %79
...
; <label>:79:                                     ; preds = %76, %75, %71, %67
  ...
  %80 = bitcast %struct.ap_uint.9* %.0.542 to i8*
  %81 = call i1 @fpga_fifo_exist_1(i8* %80)
  br i1 %81, label %82, label %83

; <label>:82:                                     ; preds = %79
  call fastcc void @streamcpy_hls.p0struct.ap_uint.9(%struct.ap_uint.9* %.01.543, %struct.ap_uint.9* %.0.542)
  br label %94
...
; <label>:83:                                     ; preds = %79
  ...
  %84 = bitcast %struct.ap_int_base.10* %.0.5.044 to i8*
  %85 = call i1 @fpga_fifo_exist_1(i8* %84)
  br i1 %85, label %86, label %87

; <label>:86:                                     ; preds = %83
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.10(%struct.ap_int_base.10* %.01.5.045, %struct.ap_int_base.10* %.0.5.044)
  br label %94
...
; <label>:87:                                     ; preds = %83
  ...
  %88 = bitcast %struct.ssdm_int.11* %.0.5.0.046 to i8*
  %89 = call i1 @fpga_fifo_exist_1(i8* %88)
  br i1 %89, label %90, label %91

; <label>:90:                                     ; preds = %87
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.11(%struct.ssdm_int.11* %.01.5.0.047, %struct.ssdm_int.11* %.0.5.0.046)
  br label %94
...
; <label>:94:                                     ; preds = %91, %90, %86, %82
  ...
  %95 = bitcast %struct.ap_uint.9* %.0.650 to i8*
  %96 = call i1 @fpga_fifo_exist_1(i8* %95)
  br i1 %96, label %97, label %98

; <label>:97:                                     ; preds = %94
  call fastcc void @streamcpy_hls.p0struct.ap_uint.9(%struct.ap_uint.9* %.01.651, %struct.ap_uint.9* %.0.650)
  br label %ret
...
; <label>:98:                                     ; preds = %94
  ...
  %99 = bitcast %struct.ap_int_base.10* %.0.6.052 to i8*
  %100 = call i1 @fpga_fifo_exist_1(i8* %99)
  br i1 %100, label %101, label %102

; <label>:101:                                    ; preds = %98
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.10(%struct.ap_int_base.10* %.01.6.053, %struct.ap_int_base.10* %.0.6.052)
  br label %ret
...
; <label>:102:                                    ; preds = %98
  ...
  %103 = bitcast %struct.ssdm_int.11* %.0.6.0.054 to i8*
  %104 = call i1 @fpga_fifo_exist_1(i8* %103)
  br i1 %104, label %105, label %106

; <label>:105:                                    ; preds = %102
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.11(%struct.ssdm_int.11* %.01.6.0.055, %struct.ssdm_int.11* %.0.6.0.054)
  br label %ret
...
; Function Attrs: noinline
define internal fastcc void @copy_out([153600 x %struct.ap_uint]*, [153600 x %struct.ap_uint]* noalias, [907200 x i32]*, [907200 x i32]* noalias readonly, [512 x %struct.ap_uint]*, [512 x %struct.ap_uint]* noalias, [4 x i32]*, [4 x i32]* noalias readonly align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #6 {
entry:
  call fastcc void @onebyonecpy_hls.p0a153600struct.ap_uint([153600 x %struct.ap_uint]* %0, [153600 x %struct.ap_uint]* %1)
  call fastcc void @onebyonecpy_hls.p0a907200i32([907200 x i32]* %2, [907200 x i32]* %3)
  call fastcc void @onebyonecpy_hls.p0a512struct.ap_uint([512 x %struct.ap_uint]* %4, [512 x %struct.ap_uint]* %5)
  call fastcc void @onebyonecpy_hls.p0a4i32([4 x i32]* %6, [4 x i32]* align 512 %7)
...
declare void @apatb_judge_index_set_1_hw(%struct.ap_uint*, i32*, %struct.ap_uint*, i32*, %"class.hls::stream"*, %"class.hls::stream"*)

define void @judge_index_set_1_hw_stub_wrapper(%struct.ap_uint*, i32*, %struct.ap_uint*, i32*, %"class.hls::stream"*, %"class.hls::stream"*) #7 {
entry:
  %6 = bitcast %struct.ap_uint* %0 to [153600 x %struct.ap_uint]*
  %7 = bitcast i32* %1 to [907200 x i32]*
  %8 = bitcast %struct.ap_uint* %2 to [512 x %struct.ap_uint]*
  %9 = bitcast i32* %3 to [4 x i32]*
  call void @copy_out([153600 x %struct.ap_uint]* null, [153600 x %struct.ap_uint]* %6, [907200 x i32]* null, [907200 x i32]* %7, [512 x %struct.ap_uint]* null, [512 x %struct.ap_uint]* %8, [4 x i32]* null, [4 x i32]* %9, %"class.hls::stream"* null, %"class.hls::stream"* %4, %"class.hls::stream"* null, %"class.hls::stream"* %5)
  %10 = bitcast [153600 x %struct.ap_uint]* %6 to %struct.ap_uint*
  %11 = bitcast [907200 x i32]* %7 to i32*
  %12 = bitcast [512 x %struct.ap_uint]* %8 to %struct.ap_uint*
  %13 = bitcast [4 x i32]* %9 to i32*
  call void @judge_index_set_1_hw_stub(%struct.ap_uint* %10, i32* %11, %struct.ap_uint* %12, i32* %13, %"class.hls::stream"* %4, %"class.hls::stream"* %5)
  call void @copy_in([153600 x %struct.ap_uint]* null, [153600 x %struct.ap_uint]* %6, [907200 x i32]* null, [907200 x i32]* %7, [512 x %struct.ap_uint]* null, [512 x %struct.ap_uint]* %8, [4 x i32]* null, [4 x i32]* %9, %"class.hls::stream"* null, %"class.hls::stream"* %4, %"class.hls::stream"* null, %"class.hls::stream"* %5)
  ret void
}

declare void @judge_index_set_1_hw_stub(%struct.ap_uint*, i32*, %struct.ap_uint*, i32*, %"class.hls::stream"*, %"class.hls::stream"*)
