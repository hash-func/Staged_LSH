; ModuleID = '/home/nomoto/src/StagedLSH/hard-StagedLSH/src/ver2.0/yan/u200/sw_emu/_x/determin/determin/determin/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_determin_ir(i32* %judge, %"class.hls::stream"* %index_stream_in1, %"class.hls::stream.6"* %complete_stream_out1_1, %"class.hls::stream.6"* %complete_stream_out1_2, %"class.hls::stream.6"* %complete_stream_in1_1, %"class.hls::stream.6"* %complete_stream_in1_2) local_unnamed_addr #0 {
entry:
...
declare void @apatb_determin_hw(i32*, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*)

define void @determin_hw_stub_wrapper(i32*, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*) #7 {
entry:
  %6 = bitcast i32* %0 to [4 x i32]*
  call void @copy_out([4 x i32]* null, [4 x i32]* %6, %"class.hls::stream"* null, %"class.hls::stream"* %1, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %2, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %3, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %4, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %5)
  %7 = bitcast [4 x i32]* %6 to i32*
  call void @determin_hw_stub(i32* %7, %"class.hls::stream"* %1, %"class.hls::stream.6"* %2, %"class.hls::stream.6"* %3, %"class.hls::stream.6"* %4, %"class.hls::stream.6"* %5)
  call void @copy_in([4 x i32]* null, [4 x i32]* %6, %"class.hls::stream"* null, %"class.hls::stream"* %1, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %2, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %3, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %4, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %5)
  ret void
}

declare void @determin_hw_stub(i32*, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*)
