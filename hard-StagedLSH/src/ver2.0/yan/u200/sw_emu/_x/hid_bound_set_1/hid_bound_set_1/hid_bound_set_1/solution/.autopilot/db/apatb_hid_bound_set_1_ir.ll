; ModuleID = '/home/nomoto/src/StagedLSH/hard-StagedLSH/src/ver2.0/yan/u200/sw_emu/_x/hid_bound_set_1/hid_bound_set_1/hid_bound_set_1/solution/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

%"class.hls::stream" = type { %"struct.hls::axis" }
%"struct.hls::axis" = type { %struct.ap_uint.0, %struct.ap_uint.4, %struct.ap_uint.4, %struct.ap_uint.7, %struct.ap_uint.7, %struct.ap_uint.7, %struct.ap_uint.7 }
%struct.ap_uint.0 = type { %struct.ap_int_base.1 }
%struct.ap_int_base.1 = type { %struct.ssdm_int.2 }
%struct.ssdm_int.2 = type { i96 }
%struct.ap_uint.4 = type { %struct.ap_int_base.5 }
%struct.ap_int_base.5 = type { %struct.ssdm_int.6 }
%struct.ssdm_int.6 = type { i12 }
%struct.ap_uint.7 = type { %struct.ap_int_base.8 }
%struct.ap_int_base.8 = type { %struct.ssdm_int.9 }
%struct.ssdm_int.9 = type { i1 }
%"class.hls::stream.10" = type { %"struct.hls::axis.11" }
%"struct.hls::axis.11" = type { %struct.ap_uint, %struct.ap_uint.12, %struct.ap_uint.12, %struct.ap_uint.7, %struct.ap_uint.7, %struct.ap_uint.7, %struct.ap_uint.7 }
...
%struct.ssdm_int.14 = type { i4 }
%"class.hls::stream.15" = type { %"struct.hls::axis.16" }
%"struct.hls::axis.16" = type { %struct.ap_uint.7, %struct.ap_uint.7, %struct.ap_uint.7, %struct.ap_uint.7, %struct.ap_uint.7, %struct.ap_uint.7, %struct.ap_uint.7 }

; Function Attrs: noinline
define void @apatb_hid_bound_set_1_ir(i32* %query, i32* %hash_table_pointer, i1 %flag, %"class.hls::stream"* %flame_stream_out, %"class.hls::stream.10"* %top_stream_out_1, %"class.hls::stream.10"* %end_stream_out_1, %"class.hls::stream.10"* %top_stream_out_2, %"class.hls::stream.10"* %end_stream_out_2, %"class.hls::stream.15"* %complete_stream_out1, %"class.hls::stream.15"* %complete_stream_out2, %"class.hls::stream.15"* %complete_stream_out3, %"class.hls::stream.15"* %complete_stream_in, %"class.hls::stream.15"* %complete_stream_out) local_unnamed_addr #0 {
entry:
  ...
  %flame_stream_out_copy = alloca %"class.hls::stream", align 512
  %top_stream_out_1_copy = alloca %"class.hls::stream.10", align 512
  %end_stream_out_1_copy = alloca %"class.hls::stream.10", align 512
  %top_stream_out_2_copy = alloca %"class.hls::stream.10", align 512
  %end_stream_out_2_copy = alloca %"class.hls::stream.10", align 512
  %complete_stream_out1_copy = alloca %"class.hls::stream.15", align 512
  %complete_stream_out2_copy = alloca %"class.hls::stream.15", align 512
  %complete_stream_out3_copy = alloca %"class.hls::stream.15", align 512
  %complete_stream_in_copy = alloca %"class.hls::stream.15", align 512
  %complete_stream_out_copy = alloca %"class.hls::stream.15", align 512
  %0 = bitcast i32* %query to [512 x i32]*
  %1 = bitcast i32* %hash_table_pointer to [32768 x i32]*
  call fastcc void @copy_in([512 x i32]* %0, [512 x i32]* nonnull align 512 %query_copy, [32768 x i32]* %1, [32768 x i32]* %hash_table_pointer_copy, %"class.hls::stream"* %flame_stream_out, %"class.hls::stream"* nonnull align 512 %flame_stream_out_copy, %"class.hls::stream.10"* %top_stream_out_1, %"class.hls::stream.10"* nonnull align 512 %top_stream_out_1_copy, %"class.hls::stream.10"* %end_stream_out_1, %"class.hls::stream.10"* nonnull align 512 %end_stream_out_1_copy, %"class.hls::stream.10"* %top_stream_out_2, %"class.hls::stream.10"* nonnull align 512 %top_stream_out_2_copy, %"class.hls::stream.10"* %end_stream_out_2, %"class.hls::stream.10"* nonnull align 512 %end_stream_out_2_copy, %"class.hls::stream.15"* %complete_stream_out1, %"class.hls::stream.15"* nonnull align 512 %complete_stream_out1_copy, %"class.hls::stream.15"* %complete_stream_out2, %"class.hls::stream.15"* nonnull align 512 %complete_stream_out2_copy, %"class.hls::stream.15"* %complete_stream_out3, %"class.hls::stream.15"* nonnull align 512 %complete_stream_out3_copy, %"class.hls::stream.15"* %complete_stream_in, %"class.hls::stream.15"* nonnull align 512 %complete_stream_in_copy, %"class.hls::stream.15"* %complete_stream_out, %"class.hls::stream.15"* nonnull align 512 %complete_stream_out_copy)
  %2 = getelementptr inbounds [512 x i32], [512 x i32]* %query_copy, i32 0, i32 0
  %3 = getelementptr inbounds [32768 x i32], [32768 x i32]* %hash_table_pointer_copy, i32 0, i32 0
  call void @apatb_hid_bound_set_1_hw(i32* %2, i32* %3, i1 %flag, %"class.hls::stream"* %flame_stream_out_copy, %"class.hls::stream.10"* %top_stream_out_1_copy, %"class.hls::stream.10"* %end_stream_out_1_copy, %"class.hls::stream.10"* %top_stream_out_2_copy, %"class.hls::stream.10"* %end_stream_out_2_copy, %"class.hls::stream.15"* %complete_stream_out1_copy, %"class.hls::stream.15"* %complete_stream_out2_copy, %"class.hls::stream.15"* %complete_stream_out3_copy, %"class.hls::stream.15"* %complete_stream_in_copy, %"class.hls::stream.15"* %complete_stream_out_copy)
  call fastcc void @copy_out([512 x i32]* %0, [512 x i32]* nonnull align 512 %query_copy, [32768 x i32]* %1, [32768 x i32]* %hash_table_pointer_copy, %"class.hls::stream"* %flame_stream_out, %"class.hls::stream"* nonnull align 512 %flame_stream_out_copy, %"class.hls::stream.10"* %top_stream_out_1, %"class.hls::stream.10"* nonnull align 512 %top_stream_out_1_copy, %"class.hls::stream.10"* %end_stream_out_1, %"class.hls::stream.10"* nonnull align 512 %end_stream_out_1_copy, %"class.hls::stream.10"* %top_stream_out_2, %"class.hls::stream.10"* nonnull align 512 %top_stream_out_2_copy, %"class.hls::stream.10"* %end_stream_out_2, %"class.hls::stream.10"* nonnull align 512 %end_stream_out_2_copy, %"class.hls::stream.15"* %complete_stream_out1, %"class.hls::stream.15"* nonnull align 512 %complete_stream_out1_copy, %"class.hls::stream.15"* %complete_stream_out2, %"class.hls::stream.15"* nonnull align 512 %complete_stream_out2_copy, %"class.hls::stream.15"* %complete_stream_out3, %"class.hls::stream.15"* nonnull align 512 %complete_stream_out3_copy, %"class.hls::stream.15"* %complete_stream_in, %"class.hls::stream.15"* nonnull align 512 %complete_stream_in_copy, %"class.hls::stream.15"* %complete_stream_out, %"class.hls::stream.15"* nonnull align 512 %complete_stream_out_copy)
...
; Function Attrs: noinline
define internal fastcc void @copy_in([512 x i32]* readonly, [512 x i32]* noalias align 512, [32768 x i32]* readonly, [32768 x i32]* noalias, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.10"*, %"class.hls::stream.10"* noalias align 512, %"class.hls::stream.10"*, %"class.hls::stream.10"* noalias align 512, %"class.hls::stream.10"*, %"class.hls::stream.10"* noalias align 512, %"class.hls::stream.10"*, %"class.hls::stream.10"* noalias align 512, %"class.hls::stream.15"*, %"class.hls::stream.15"* noalias align 512, %"class.hls::stream.15"*, %"class.hls::stream.15"* noalias align 512, %"class.hls::stream.15"*, %"class.hls::stream.15"* noalias align 512, %"class.hls::stream.15"*, %"class.hls::stream.15"* noalias align 512, %"class.hls::stream.15"*, %"class.hls::stream.15"* noalias align 512) unnamed_addr #1 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.10"(%"class.hls::stream.10"* align 512 %9, %"class.hls::stream.10"* %8)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.10"(%"class.hls::stream.10"* align 512 %11, %"class.hls::stream.10"* %10)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.10"(%"class.hls::stream.10"* align 512 %13, %"class.hls::stream.10"* %12)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.15"(%"class.hls::stream.15"* align 512 %15, %"class.hls::stream.15"* %14)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.15"(%"class.hls::stream.15"* align 512 %17, %"class.hls::stream.15"* %16)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.15"(%"class.hls::stream.15"* align 512 %19, %"class.hls::stream.15"* %18)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.15"(%"class.hls::stream.15"* align 512 %21, %"class.hls::stream.15"* %20)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.15"(%"class.hls::stream.15"* align 512 %23, %"class.hls::stream.15"* %22)
  ret void
}
...
; <label>:22:                                     ; preds = %19
  call fastcc void @streamcpy_hls.p0struct.ap_uint.4(%struct.ap_uint.4* align 16 %.01.111, %struct.ap_uint.4* %.0.110)
  br label %34
...
; <label>:26:                                     ; preds = %23
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.5(%struct.ap_int_base.5* align 16 %.01.1.013, %struct.ap_int_base.5* %.0.1.012)
  br label %34
...
; <label>:30:                                     ; preds = %27
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.6(%struct.ssdm_int.6* align 16 %.01.1.0.015, %struct.ssdm_int.6* %.0.1.0.014)
  br label %34
...
; <label>:34:                                     ; preds = %31, %30, %26, %22
  ...
  %35 = bitcast %struct.ap_uint.4* %.0.218 to i8*
  %36 = call i1 @fpga_fifo_exist_2(i8* %35)
  br i1 %36, label %37, label %38

; <label>:37:                                     ; preds = %34
  call fastcc void @streamcpy_hls.p0struct.ap_uint.4(%struct.ap_uint.4* %.01.219, %struct.ap_uint.4* %.0.218)
  br label %49
...
; <label>:38:                                     ; preds = %34
  ...
  %39 = bitcast %struct.ap_int_base.5* %.0.2.020 to i8*
  %40 = call i1 @fpga_fifo_exist_2(i8* %39)
  br i1 %40, label %41, label %42

; <label>:41:                                     ; preds = %38
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.5(%struct.ap_int_base.5* %.01.2.021, %struct.ap_int_base.5* %.0.2.020)
  br label %49
...
; <label>:42:                                     ; preds = %38
  ...
  %43 = bitcast %struct.ssdm_int.6* %.0.2.0.022 to i8*
  %44 = call i1 @fpga_fifo_exist_2(i8* %43)
  br i1 %44, label %45, label %46

; <label>:45:                                     ; preds = %42
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.6(%struct.ssdm_int.6* %.01.2.0.023, %struct.ssdm_int.6* %.0.2.0.022)
  br label %49
...
; <label>:49:                                     ; preds = %46, %45, %41, %37
  ...
  %50 = bitcast %struct.ap_uint.7* %.0.326 to i8*
  %51 = call i1 @fpga_fifo_exist_1(i8* %50)
  br i1 %51, label %52, label %53

; <label>:52:                                     ; preds = %49
  call fastcc void @streamcpy_hls.p0struct.ap_uint.7(%struct.ap_uint.7* %.01.327, %struct.ap_uint.7* %.0.326)
  br label %64
...
; <label>:53:                                     ; preds = %49
  ...
  %54 = bitcast %struct.ap_int_base.8* %.0.3.028 to i8*
  %55 = call i1 @fpga_fifo_exist_1(i8* %54)
  br i1 %55, label %56, label %57

; <label>:56:                                     ; preds = %53
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.8(%struct.ap_int_base.8* %.01.3.029, %struct.ap_int_base.8* %.0.3.028)
  br label %64
...
; <label>:57:                                     ; preds = %53
  ...
  %58 = bitcast %struct.ssdm_int.9* %.0.3.0.030 to i8*
  %59 = call i1 @fpga_fifo_exist_1(i8* %58)
  br i1 %59, label %60, label %61

; <label>:60:                                     ; preds = %57
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.9(%struct.ssdm_int.9* %.01.3.0.031, %struct.ssdm_int.9* %.0.3.0.030)
  br label %64
...
; <label>:64:                                     ; preds = %61, %60, %56, %52
  ...
  %65 = bitcast %struct.ap_uint.7* %.0.434 to i8*
  %66 = call i1 @fpga_fifo_exist_1(i8* %65)
  br i1 %66, label %67, label %68

; <label>:67:                                     ; preds = %64
  call fastcc void @streamcpy_hls.p0struct.ap_uint.7(%struct.ap_uint.7* %.01.435, %struct.ap_uint.7* %.0.434)
  br label %79
...
; <label>:68:                                     ; preds = %64
  ...
  %69 = bitcast %struct.ap_int_base.8* %.0.4.036 to i8*
  %70 = call i1 @fpga_fifo_exist_1(i8* %69)
  br i1 %70, label %71, label %72

; <label>:71:                                     ; preds = %68
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.8(%struct.ap_int_base.8* %.01.4.037, %struct.ap_int_base.8* %.0.4.036)
  br label %79
...
; <label>:72:                                     ; preds = %68
  ...
  %73 = bitcast %struct.ssdm_int.9* %.0.4.0.038 to i8*
  %74 = call i1 @fpga_fifo_exist_1(i8* %73)
  br i1 %74, label %75, label %76

; <label>:75:                                     ; preds = %72
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.9(%struct.ssdm_int.9* %.01.4.0.039, %struct.ssdm_int.9* %.0.4.0.038)
  br label %79
...
; <label>:79:                                     ; preds = %76, %75, %71, %67
  ...
  %80 = bitcast %struct.ap_uint.7* %.0.542 to i8*
  %81 = call i1 @fpga_fifo_exist_1(i8* %80)
  br i1 %81, label %82, label %83

; <label>:82:                                     ; preds = %79
  call fastcc void @streamcpy_hls.p0struct.ap_uint.7(%struct.ap_uint.7* %.01.543, %struct.ap_uint.7* %.0.542)
  br label %94
...
; <label>:83:                                     ; preds = %79
  ...
  %84 = bitcast %struct.ap_int_base.8* %.0.5.044 to i8*
  %85 = call i1 @fpga_fifo_exist_1(i8* %84)
  br i1 %85, label %86, label %87

; <label>:86:                                     ; preds = %83
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.8(%struct.ap_int_base.8* %.01.5.045, %struct.ap_int_base.8* %.0.5.044)
  br label %94
...
; <label>:87:                                     ; preds = %83
  ...
  %88 = bitcast %struct.ssdm_int.9* %.0.5.0.046 to i8*
  %89 = call i1 @fpga_fifo_exist_1(i8* %88)
  br i1 %89, label %90, label %91

; <label>:90:                                     ; preds = %87
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.9(%struct.ssdm_int.9* %.01.5.0.047, %struct.ssdm_int.9* %.0.5.0.046)
  br label %94
...
; <label>:94:                                     ; preds = %91, %90, %86, %82
  ...
  %95 = bitcast %struct.ap_uint.7* %.0.650 to i8*
  %96 = call i1 @fpga_fifo_exist_1(i8* %95)
  br i1 %96, label %97, label %98

; <label>:97:                                     ; preds = %94
  call fastcc void @streamcpy_hls.p0struct.ap_uint.7(%struct.ap_uint.7* %.01.651, %struct.ap_uint.7* %.0.650)
  br label %ret
...
; <label>:98:                                     ; preds = %94
  ...
  %99 = bitcast %struct.ap_int_base.8* %.0.6.052 to i8*
  %100 = call i1 @fpga_fifo_exist_1(i8* %99)
  br i1 %100, label %101, label %102

; <label>:101:                                    ; preds = %98
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.8(%struct.ap_int_base.8* %.01.6.053, %struct.ap_int_base.8* %.0.6.052)
  br label %ret
...
; <label>:102:                                    ; preds = %98
  ...
  %103 = bitcast %struct.ssdm_int.9* %.0.6.0.054 to i8*
  %104 = call i1 @fpga_fifo_exist_1(i8* %103)
  br i1 %104, label %105, label %106

; <label>:105:                                    ; preds = %102
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.9(%struct.ssdm_int.9* %.01.6.0.055, %struct.ssdm_int.9* %.0.6.0.054)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_uint.4(%struct.ap_uint.4* noalias nocapture, %struct.ap_uint.4* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_int_base.5(%struct.ap_int_base.5* noalias nocapture, %struct.ap_int_base.5* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ssdm_int.6(%struct.ssdm_int.6* noalias nocapture, %struct.ssdm_int.6* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_uint.7(%struct.ap_uint.7* noalias nocapture, %struct.ap_uint.7* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_int_base.8(%struct.ap_int_base.8* noalias nocapture, %struct.ap_int_base.8* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ssdm_int.9(%struct.ssdm_int.9* noalias nocapture, %struct.ssdm_int.9* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream.10"(%"class.hls::stream.10"* noalias align 512, %"class.hls::stream.10"* noalias) unnamed_addr #4 {
entry:
...
; <label>:19:                                     ; preds = %17, %16, %13, %10
  ...
  %20 = bitcast %struct.ap_uint.12* %.0.110 to i8*
  %21 = call i1 @fpga_fifo_exist_1(i8* %20)
  br i1 %21, label %22, label %23

; <label>:22:                                     ; preds = %19
  call fastcc void @streamcpy_hls.p0struct.ap_uint.12(%struct.ap_uint.12* %.01.111, %struct.ap_uint.12* %.0.110)
  br label %34
...
; <label>:23:                                     ; preds = %19
  ...
  %24 = bitcast %struct.ap_int_base.13* %.0.1.012 to i8*
  %25 = call i1 @fpga_fifo_exist_1(i8* %24)
  br i1 %25, label %26, label %27

; <label>:26:                                     ; preds = %23
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.13(%struct.ap_int_base.13* %.01.1.013, %struct.ap_int_base.13* %.0.1.012)
  br label %34
...
; <label>:27:                                     ; preds = %23
  ...
  %28 = bitcast %struct.ssdm_int.14* %.0.1.0.014 to i8*
  %29 = call i1 @fpga_fifo_exist_1(i8* %28)
  br i1 %29, label %30, label %31

; <label>:30:                                     ; preds = %27
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.14(%struct.ssdm_int.14* %.01.1.0.015, %struct.ssdm_int.14* %.0.1.0.014)
  br label %34
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream.10"(%"class.hls::stream.10"* noalias nocapture align 512, %"class.hls::stream.10"* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_uint.12(%struct.ap_uint.12* noalias nocapture, %struct.ap_uint.12* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_int_base.13(%struct.ap_int_base.13* noalias nocapture, %struct.ap_int_base.13* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ssdm_int.14(%struct.ssdm_int.14* noalias nocapture, %struct.ssdm_int.14* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream.15"(%"class.hls::stream.15"* noalias align 512, %"class.hls::stream.15"* noalias) unnamed_addr #4 {
entry:
...
; <label>:19:                                     ; preds = %17, %16, %13, %10
  ...
  %20 = bitcast %struct.ap_uint.7* %.0.110 to i8*
  %21 = call i1 @fpga_fifo_exist_1(i8* %20)
  br i1 %21, label %22, label %23

; <label>:22:                                     ; preds = %19
  call fastcc void @streamcpy_hls.p0struct.ap_uint.7(%struct.ap_uint.7* %.01.111, %struct.ap_uint.7* %.0.110)
  br label %34
...
; <label>:23:                                     ; preds = %19
  ...
  %24 = bitcast %struct.ap_int_base.8* %.0.1.012 to i8*
  %25 = call i1 @fpga_fifo_exist_1(i8* %24)
  br i1 %25, label %26, label %27

; <label>:26:                                     ; preds = %23
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.8(%struct.ap_int_base.8* %.01.1.013, %struct.ap_int_base.8* %.0.1.012)
  br label %34
...
; <label>:27:                                     ; preds = %23
  ...
  %28 = bitcast %struct.ssdm_int.9* %.0.1.0.014 to i8*
  %29 = call i1 @fpga_fifo_exist_1(i8* %28)
  br i1 %29, label %30, label %31

; <label>:30:                                     ; preds = %27
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.9(%struct.ssdm_int.9* %.01.1.0.015, %struct.ssdm_int.9* %.0.1.0.014)
  br label %34

; <label>:31:                                     ; preds = %27
  %.01.1.0.0.017.gep59 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %0, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
  %32 = bitcast i1* %.01.1.0.0.017.gep59 to i8*
  %.0.1.0.0.016.gep60 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %1, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
...
; <label>:46:                                     ; preds = %42
  %.01.2.0.0.025.gep61 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %0, i32 0, i32 0, i32 2, i32 0, i32 0, i32 0
  %47 = bitcast i1* %.01.2.0.0.025.gep61 to i8*
  %.0.2.0.0.024.gep62 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %1, i32 0, i32 0, i32 2, i32 0, i32 0, i32 0
...
; <label>:61:                                     ; preds = %57
  %.01.3.0.0.033.gep63 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %0, i32 0, i32 0, i32 3, i32 0, i32 0, i32 0
  %62 = bitcast i1* %.01.3.0.0.033.gep63 to i8*
  %.0.3.0.0.032.gep64 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %1, i32 0, i32 0, i32 3, i32 0, i32 0, i32 0
  %63 = bitcast i1* %.0.3.0.0.032.gep64 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %62, i8* align 1 %63, i64 1, i1 false)
  br label %64

; <label>:64:                                     ; preds = %61, %60, %56, %52
  %.0.434 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %1, i32 0, i32 0, i32 4
  %.01.435 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %0, i32 0, i32 0, i32 4
  %65 = bitcast %struct.ap_uint.7* %.0.434 to i8*
  %66 = call i1 @fpga_fifo_exist_1(i8* %65)
  br i1 %66, label %67, label %68
...
; <label>:68:                                     ; preds = %64
  %.0.4.036 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %1, i32 0, i32 0, i32 4, i32 0
  %.01.4.037 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %0, i32 0, i32 0, i32 4, i32 0
  %69 = bitcast %struct.ap_int_base.8* %.0.4.036 to i8*
  %70 = call i1 @fpga_fifo_exist_1(i8* %69)
  br i1 %70, label %71, label %72
...
; <label>:72:                                     ; preds = %68
  %.0.4.0.038 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %1, i32 0, i32 0, i32 4, i32 0, i32 0
  %.01.4.0.039 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %0, i32 0, i32 0, i32 4, i32 0, i32 0
  %73 = bitcast %struct.ssdm_int.9* %.0.4.0.038 to i8*
  %74 = call i1 @fpga_fifo_exist_1(i8* %73)
  br i1 %74, label %75, label %76
...
; <label>:76:                                     ; preds = %72
  %.01.4.0.0.041.gep65 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %0, i32 0, i32 0, i32 4, i32 0, i32 0, i32 0
  %77 = bitcast i1* %.01.4.0.0.041.gep65 to i8*
  %.0.4.0.0.040.gep66 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %1, i32 0, i32 0, i32 4, i32 0, i32 0, i32 0
  %78 = bitcast i1* %.0.4.0.0.040.gep66 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %77, i8* align 1 %78, i64 1, i1 false)
  br label %79

; <label>:79:                                     ; preds = %76, %75, %71, %67
  %.0.542 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %1, i32 0, i32 0, i32 5
  %.01.543 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %0, i32 0, i32 0, i32 5
  %80 = bitcast %struct.ap_uint.7* %.0.542 to i8*
  %81 = call i1 @fpga_fifo_exist_1(i8* %80)
  br i1 %81, label %82, label %83
...
; <label>:83:                                     ; preds = %79
  %.0.5.044 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %1, i32 0, i32 0, i32 5, i32 0
  %.01.5.045 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %0, i32 0, i32 0, i32 5, i32 0
  %84 = bitcast %struct.ap_int_base.8* %.0.5.044 to i8*
  %85 = call i1 @fpga_fifo_exist_1(i8* %84)
  br i1 %85, label %86, label %87
...
; <label>:87:                                     ; preds = %83
  %.0.5.0.046 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %1, i32 0, i32 0, i32 5, i32 0, i32 0
  %.01.5.0.047 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %0, i32 0, i32 0, i32 5, i32 0, i32 0
  %88 = bitcast %struct.ssdm_int.9* %.0.5.0.046 to i8*
  %89 = call i1 @fpga_fifo_exist_1(i8* %88)
  br i1 %89, label %90, label %91
...
; <label>:91:                                     ; preds = %87
  %.01.5.0.0.049.gep67 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %0, i32 0, i32 0, i32 5, i32 0, i32 0, i32 0
  %92 = bitcast i1* %.01.5.0.0.049.gep67 to i8*
  %.0.5.0.0.048.gep68 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %1, i32 0, i32 0, i32 5, i32 0, i32 0, i32 0
  %93 = bitcast i1* %.0.5.0.0.048.gep68 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %92, i8* align 1 %93, i64 1, i1 false)
  br label %94

; <label>:94:                                     ; preds = %91, %90, %86, %82
  %.0.650 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %1, i32 0, i32 0, i32 6
  %.01.651 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %0, i32 0, i32 0, i32 6
  %95 = bitcast %struct.ap_uint.7* %.0.650 to i8*
  %96 = call i1 @fpga_fifo_exist_1(i8* %95)
  br i1 %96, label %97, label %98
...
; <label>:98:                                     ; preds = %94
  %.0.6.052 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %1, i32 0, i32 0, i32 6, i32 0
  %.01.6.053 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %0, i32 0, i32 0, i32 6, i32 0
  %99 = bitcast %struct.ap_int_base.8* %.0.6.052 to i8*
  %100 = call i1 @fpga_fifo_exist_1(i8* %99)
  br i1 %100, label %101, label %102
...
; <label>:102:                                    ; preds = %98
  %.0.6.0.054 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %1, i32 0, i32 0, i32 6, i32 0, i32 0
  %.01.6.0.055 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %0, i32 0, i32 0, i32 6, i32 0, i32 0
  %103 = bitcast %struct.ssdm_int.9* %.0.6.0.054 to i8*
  %104 = call i1 @fpga_fifo_exist_1(i8* %103)
  br i1 %104, label %105, label %106
...
; <label>:106:                                    ; preds = %102
  %.01.6.0.0.057.gep69 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %0, i32 0, i32 0, i32 6, i32 0, i32 0, i32 0
  %107 = bitcast i1* %.01.6.0.0.057.gep69 to i8*
  %.0.6.0.0.056.gep70 = getelementptr %"class.hls::stream.15", %"class.hls::stream.15"* %1, i32 0, i32 0, i32 6, i32 0, i32 0, i32 0
  %108 = bitcast i1* %.0.6.0.0.056.gep70 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %107, i8* align 1 %108, i64 1, i1 false)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream.15"(%"class.hls::stream.15"* noalias nocapture align 512, %"class.hls::stream.15"* noalias nocapture) unnamed_addr #5 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out([512 x i32]*, [512 x i32]* noalias readonly align 512, [32768 x i32]*, [32768 x i32]* noalias readonly, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.10"*, %"class.hls::stream.10"* noalias align 512, %"class.hls::stream.10"*, %"class.hls::stream.10"* noalias align 512, %"class.hls::stream.10"*, %"class.hls::stream.10"* noalias align 512, %"class.hls::stream.10"*, %"class.hls::stream.10"* noalias align 512, %"class.hls::stream.15"*, %"class.hls::stream.15"* noalias align 512, %"class.hls::stream.15"*, %"class.hls::stream.15"* noalias align 512, %"class.hls::stream.15"*, %"class.hls::stream.15"* noalias align 512, %"class.hls::stream.15"*, %"class.hls::stream.15"* noalias align 512, %"class.hls::stream.15"*, %"class.hls::stream.15"* noalias align 512) unnamed_addr #6 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.10"(%"class.hls::stream.10"* %8, %"class.hls::stream.10"* align 512 %9)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.10"(%"class.hls::stream.10"* %10, %"class.hls::stream.10"* align 512 %11)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.10"(%"class.hls::stream.10"* %12, %"class.hls::stream.10"* align 512 %13)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.15"(%"class.hls::stream.15"* %14, %"class.hls::stream.15"* align 512 %15)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.15"(%"class.hls::stream.15"* %16, %"class.hls::stream.15"* align 512 %17)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.15"(%"class.hls::stream.15"* %18, %"class.hls::stream.15"* align 512 %19)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.15"(%"class.hls::stream.15"* %20, %"class.hls::stream.15"* align 512 %21)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.15"(%"class.hls::stream.15"* %22, %"class.hls::stream.15"* align 512 %23)
  ret void
}

declare void @free(i8*) local_unnamed_addr

declare void @apatb_hid_bound_set_1_hw(i32*, i32*, i1, %"class.hls::stream"*, %"class.hls::stream.10"*, %"class.hls::stream.10"*, %"class.hls::stream.10"*, %"class.hls::stream.10"*, %"class.hls::stream.15"*, %"class.hls::stream.15"*, %"class.hls::stream.15"*, %"class.hls::stream.15"*, %"class.hls::stream.15"*)

define void @hid_bound_set_1_hw_stub_wrapper(i32*, i32*, i1, %"class.hls::stream"*, %"class.hls::stream.10"*, %"class.hls::stream.10"*, %"class.hls::stream.10"*, %"class.hls::stream.10"*, %"class.hls::stream.15"*, %"class.hls::stream.15"*, %"class.hls::stream.15"*, %"class.hls::stream.15"*, %"class.hls::stream.15"*) #7 {
entry:
  %13 = bitcast i32* %0 to [512 x i32]*
  %14 = bitcast i32* %1 to [32768 x i32]*
  call void @copy_out([512 x i32]* null, [512 x i32]* %13, [32768 x i32]* null, [32768 x i32]* %14, %"class.hls::stream"* null, %"class.hls::stream"* %3, %"class.hls::stream.10"* null, %"class.hls::stream.10"* %4, %"class.hls::stream.10"* null, %"class.hls::stream.10"* %5, %"class.hls::stream.10"* null, %"class.hls::stream.10"* %6, %"class.hls::stream.10"* null, %"class.hls::stream.10"* %7, %"class.hls::stream.15"* null, %"class.hls::stream.15"* %8, %"class.hls::stream.15"* null, %"class.hls::stream.15"* %9, %"class.hls::stream.15"* null, %"class.hls::stream.15"* %10, %"class.hls::stream.15"* null, %"class.hls::stream.15"* %11, %"class.hls::stream.15"* null, %"class.hls::stream.15"* %12)
  %15 = bitcast [512 x i32]* %13 to i32*
  %16 = bitcast [32768 x i32]* %14 to i32*
  call void @hid_bound_set_1_hw_stub(i32* %15, i32* %16, i1 %2, %"class.hls::stream"* %3, %"class.hls::stream.10"* %4, %"class.hls::stream.10"* %5, %"class.hls::stream.10"* %6, %"class.hls::stream.10"* %7, %"class.hls::stream.15"* %8, %"class.hls::stream.15"* %9, %"class.hls::stream.15"* %10, %"class.hls::stream.15"* %11, %"class.hls::stream.15"* %12)
  call void @copy_in([512 x i32]* null, [512 x i32]* %13, [32768 x i32]* null, [32768 x i32]* %14, %"class.hls::stream"* null, %"class.hls::stream"* %3, %"class.hls::stream.10"* null, %"class.hls::stream.10"* %4, %"class.hls::stream.10"* null, %"class.hls::stream.10"* %5, %"class.hls::stream.10"* null, %"class.hls::stream.10"* %6, %"class.hls::stream.10"* null, %"class.hls::stream.10"* %7, %"class.hls::stream.15"* null, %"class.hls::stream.15"* %8, %"class.hls::stream.15"* null, %"class.hls::stream.15"* %9, %"class.hls::stream.15"* null, %"class.hls::stream.15"* %10, %"class.hls::stream.15"* null, %"class.hls::stream.15"* %11, %"class.hls::stream.15"* null, %"class.hls::stream.15"* %12)
  ret void
}

declare void @hid_bound_set_1_hw_stub(i32*, i32*, i1, %"class.hls::stream"*, %"class.hls::stream.10"*, %"class.hls::stream.10"*, %"class.hls::stream.10"*, %"class.hls::stream.10"*, %"class.hls::stream.15"*, %"class.hls::stream.15"*, %"class.hls::stream.15"*, %"class.hls::stream.15"*, %"class.hls::stream.15"*)
