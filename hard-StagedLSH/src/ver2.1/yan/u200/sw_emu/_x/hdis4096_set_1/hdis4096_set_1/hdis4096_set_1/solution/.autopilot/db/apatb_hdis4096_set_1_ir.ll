; ModuleID = '/home/nomoto/src/StagedLSH/hard-StagedLSH/src/ver2.1/yan/u200/sw_emu/_x/hdis4096_set_1/hdis4096_set_1/hdis4096_set_1/solution/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

%"class.hls::stream" = type { %"struct.hls::axis" }
%"struct.hls::axis" = type { %struct.ap_uint.3, %struct.ap_uint.3, %struct.ap_uint.3, %struct.ap_uint.3, %struct.ap_uint.3, %struct.ap_uint.3, %struct.ap_uint.3 }
...
%"struct.hls::axis.7" = type { %struct.ap_uint, %struct.ap_uint.8, %struct.ap_uint.8, %struct.ap_uint.3, %struct.ap_uint.3, %struct.ap_uint.3, %struct.ap_uint.3 }
...
define void @apatb_hdis4096_set_1_ir(i32* %query, %"class.hls::stream"* %complete_stream_in, %"class.hls::stream"* %complete_stream_out, %"class.hls::stream.6"* %fp32_stream_in, %"class.hls::stream.6"* %haming_stream_out) local_unnamed_addr #0 {
entry:
  %query_copy = alloca [512 x i32], align 512
  %complete_stream_in_copy = alloca %"class.hls::stream", align 512
  %complete_stream_out_copy = alloca %"class.hls::stream", align 512
  %fp32_stream_in_copy = alloca %"class.hls::stream.6", align 512
  %haming_stream_out_copy = alloca %"class.hls::stream.6", align 512
  %0 = bitcast i32* %query to [512 x i32]*
  call fastcc void @copy_in([512 x i32]* %0, [512 x i32]* nonnull align 512 %query_copy, %"class.hls::stream"* %complete_stream_in, %"class.hls::stream"* nonnull align 512 %complete_stream_in_copy, %"class.hls::stream"* %complete_stream_out, %"class.hls::stream"* nonnull align 512 %complete_stream_out_copy, %"class.hls::stream.6"* %fp32_stream_in, %"class.hls::stream.6"* nonnull align 512 %fp32_stream_in_copy, %"class.hls::stream.6"* %haming_stream_out, %"class.hls::stream.6"* nonnull align 512 %haming_stream_out_copy)
  %1 = getelementptr inbounds [512 x i32], [512 x i32]* %query_copy, i32 0, i32 0
  call void @apatb_hdis4096_set_1_hw(i32* %1, %"class.hls::stream"* %complete_stream_in_copy, %"class.hls::stream"* %complete_stream_out_copy, %"class.hls::stream.6"* %fp32_stream_in_copy, %"class.hls::stream.6"* %haming_stream_out_copy)
...
declare void @apatb_hdis4096_set_1_hw(i32*, %"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*)

define void @hdis4096_set_1_hw_stub_wrapper(i32*, %"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*) #7 {
entry:
  %5 = bitcast i32* %0 to [512 x i32]*
  call void @copy_out([512 x i32]* null, [512 x i32]* %5, %"class.hls::stream"* null, %"class.hls::stream"* %1, %"class.hls::stream"* null, %"class.hls::stream"* %2, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %3, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %4)
  %6 = bitcast [512 x i32]* %5 to i32*
  call void @hdis4096_set_1_hw_stub(i32* %6, %"class.hls::stream"* %1, %"class.hls::stream"* %2, %"class.hls::stream.6"* %3, %"class.hls::stream.6"* %4)
  call void @copy_in([512 x i32]* null, [512 x i32]* %5, %"class.hls::stream"* null, %"class.hls::stream"* %1, %"class.hls::stream"* null, %"class.hls::stream"* %2, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %3, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %4)
  ret void
}

declare void @hdis4096_set_1_hw_stub(i32*, %"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*)
