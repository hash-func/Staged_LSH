...
void hid_bound_set_1(size_t hash_table_pointer, size_t flame_stream_in, size_t flame_stream_out, size_t top_stream_out_1, size_t end_stream_out_1, size_t top_stream_out_2, size_t end_stream_out_2, size_t complete_stream_in);
...
void __stub____xlnx_cl_hid_bound_set_1(char **argv) {
  void **args = (void **)argv;
  size_t hash_table_pointer = *((size_t*)args[0+1]);
  size_t flame_stream_in = *((size_t*)args[1+1]);
  size_t flame_stream_out = *((size_t*)args[2+1]);
  size_t top_stream_out_1 = *((size_t*)args[3+1]);
  size_t end_stream_out_1 = *((size_t*)args[4+1]);
  size_t top_stream_out_2 = *((size_t*)args[5+1]);
  size_t end_stream_out_2 = *((size_t*)args[6+1]);
  size_t complete_stream_in = *((size_t*)args[7+1]);
 //  pthread_mutex_lock(&__xlnx_cl_hid_bound_set_1_mutex);
  hid_bound_set_1(hash_table_pointer, flame_stream_in, flame_stream_out, top_stream_out_1, end_stream_out_1, top_stream_out_2, end_stream_out_2, complete_stream_in);
 //   pthread_mutex_unlock(&__xlnx_cl_hid_bound_set_1_mutex);
}
void query_set_1(size_t query, unsigned int flag, size_t flame_stream_out, size_t complete_stream_out1, size_t complete_stream_out2, size_t complete_stream_out3, size_t complete_stream_out4, size_t continue_stream_in, size_t complete_stream_in, size_t complete_stream_out);

static pthread_mutex_t __xlnx_cl_query_set_1_mutex = PTHREAD_MUTEX_INITIALIZER;
void __stub____xlnx_cl_query_set_1(char **argv) {
  void **args = (void **)argv;
  size_t query = *((size_t*)args[0+1]);
  unsigned int flag = *((unsigned int*)args[1+1]);
  size_t flame_stream_out = *((size_t*)args[2+1]);
  size_t complete_stream_out1 = *((size_t*)args[3+1]);
  size_t complete_stream_out2 = *((size_t*)args[4+1]);
  size_t complete_stream_out3 = *((size_t*)args[5+1]);
  size_t complete_stream_out4 = *((size_t*)args[6+1]);
  size_t continue_stream_in = *((size_t*)args[7+1]);
  size_t complete_stream_in = *((size_t*)args[8+1]);
  size_t complete_stream_out = *((size_t*)args[9+1]);
 //  pthread_mutex_lock(&__xlnx_cl_query_set_1_mutex);
  query_set_1(query, flag, flame_stream_out, complete_stream_out1, complete_stream_out2, complete_stream_out3, complete_stream_out4, continue_stream_in, complete_stream_in, complete_stream_out);
 //   pthread_mutex_unlock(&__xlnx_cl_query_set_1_mutex);
}
void determin(size_t judge, size_t index_stream_in1, size_t continue_stream_out1_1, size_t complete_stream_out1_1, size_t complete_stream_out1_2, size_t complete_stream_in1_1, size_t complete_stream_in1_2);
...
void __stub____xlnx_cl_determin(char **argv) {
  ...
  size_t continue_stream_out1_1 = *((size_t*)args[2+1]);
  size_t complete_stream_out1_1 = *((size_t*)args[3+1]);
  size_t complete_stream_out1_2 = *((size_t*)args[4+1]);
  size_t complete_stream_in1_1 = *((size_t*)args[5+1]);
  size_t complete_stream_in1_2 = *((size_t*)args[6+1]);
 //  pthread_mutex_lock(&__xlnx_cl_determin_mutex);
  determin(judge, index_stream_in1, continue_stream_out1_1, complete_stream_out1_1, complete_stream_out1_2, complete_stream_in1_1, complete_stream_in1_2);
...
__XLNX_DEFINE_STREAM_FUNCS__(query_set_1,hlsaxisapuint10,__xlnx_cl_struct_type_5) 

typedef hls::axis<ap_uint<1>, 0, 0, 0> __xlnx_cl_struct_type_6;
__XLNX_DEFINE_STREAM_FUNCS__(switch_set_1,hlsaxisapuint10,__xlnx_cl_struct_type_6) 

typedef hls::axis<ap_uint<32>, 0, 0, 0> __xlnx_cl_struct_type_7;
__XLNX_DEFINE_STREAM_FUNCS__(determin,hlsaxisapuint32,__xlnx_cl_struct_type_7) 

typedef hls::axis<ap_uint<32>, 0, 0, 0> __xlnx_cl_struct_type_8;
__XLNX_DEFINE_STREAM_FUNCS__(hdis4096_set_1,hlsaxisapuint32,__xlnx_cl_struct_type_8) 

typedef hls::axis<ap_uint<32>, 0, 0, 0> __xlnx_cl_struct_type_9;
__XLNX_DEFINE_STREAM_FUNCS__(hdis96_set_1,hlsaxisapuint32,__xlnx_cl_struct_type_9) 

typedef hls::axis<ap_uint<32>, 0, 0, 0> __xlnx_cl_struct_type_10;
__XLNX_DEFINE_STREAM_FUNCS__(hid_bound_set_1,hlsaxisapuint32,__xlnx_cl_struct_type_10) 

typedef hls::axis<ap_uint<32>, 0, 0, 0> __xlnx_cl_struct_type_11;
__XLNX_DEFINE_STREAM_FUNCS__(judge_index_set_1,hlsaxisapuint32,__xlnx_cl_struct_type_11) 

typedef hls::axis<ap_uint<32>, 0, 0, 0> __xlnx_cl_struct_type_12;
__XLNX_DEFINE_STREAM_FUNCS__(switch_set_1,hlsaxisapuint32,__xlnx_cl_struct_type_12) 

typedef hls::axis<ap_uint<96>, 0, 0, 0> __xlnx_cl_struct_type_13;
__XLNX_DEFINE_STREAM_FUNCS__(hdis96_set_1,hlsaxisapuint96,__xlnx_cl_struct_type_13) 

typedef hls::axis<ap_uint<96>, 0, 0, 0> __xlnx_cl_struct_type_14;
__XLNX_DEFINE_STREAM_FUNCS__(hid_bound_set_1,hlsaxisapuint96,__xlnx_cl_struct_type_14) 

typedef hls::axis<ap_uint<96>, 0, 0, 0> __xlnx_cl_struct_type_15;
__XLNX_DEFINE_STREAM_FUNCS__(query_set_1,hlsaxisapuint96,__xlnx_cl_struct_type_15) 

typedef hls::axis<ap_uint<96>, 0, 0, 0> __xlnx_cl_struct_type_16;
__XLNX_DEFINE_STREAM_FUNCS__(switch_set_1,hlsaxisapuint96,__xlnx_cl_struct_type_16) 
}
