; ModuleID = '/home/nomoto/src/StagedLSH/hard-StagedLSH/src/ver2.1/yan/u200/sw_emu/_x/hid_bound_set_1/hid_bound_set_1/hid_bound_set_1/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_hid_bound_set_1_ir(i32* %hash_table_pointer, %"class.hls::stream"* %flame_stream_in, %"class.hls::stream"* %flame_stream_out, %"class.hls::stream.10"* %top_stream_out_1, %"class.hls::stream.10"* %end_stream_out_1, %"class.hls::stream.10"* %top_stream_out_2, %"class.hls::stream.10"* %end_stream_out_2, %"class.hls::stream.15"* %complete_stream_in) local_unnamed_addr #0 {
entry:
  %malloccall = tail call i8* @malloc(i64 131072)
  %hash_table_pointer_copy = bitcast i8* %malloccall to [32768 x i32]*
  %flame_stream_in_copy = alloca %"class.hls::stream", align 512
  ...
  %0 = bitcast i32* %hash_table_pointer to [32768 x i32]*
  call fastcc void @copy_in([32768 x i32]* %0, [32768 x i32]* %hash_table_pointer_copy, %"class.hls::stream"* %flame_stream_in, %"class.hls::stream"* nonnull align 512 %flame_stream_in_copy, %"class.hls::stream"* %flame_stream_out, %"class.hls::stream"* nonnull align 512 %flame_stream_out_copy, %"class.hls::stream.10"* %top_stream_out_1, %"class.hls::stream.10"* nonnull align 512 %top_stream_out_1_copy, %"class.hls::stream.10"* %end_stream_out_1, %"class.hls::stream.10"* nonnull align 512 %end_stream_out_1_copy, %"class.hls::stream.10"* %top_stream_out_2, %"class.hls::stream.10"* nonnull align 512 %top_stream_out_2_copy, %"class.hls::stream.10"* %end_stream_out_2, %"class.hls::stream.10"* nonnull align 512 %end_stream_out_2_copy, %"class.hls::stream.15"* %complete_stream_in, %"class.hls::stream.15"* nonnull align 512 %complete_stream_in_copy)
  %1 = getelementptr inbounds [32768 x i32], [32768 x i32]* %hash_table_pointer_copy, i32 0, i32 0
  call void @apatb_hid_bound_set_1_hw(i32* %1, %"class.hls::stream"* %flame_stream_in_copy, %"class.hls::stream"* %flame_stream_out_copy, %"class.hls::stream.10"* %top_stream_out_1_copy, %"class.hls::stream.10"* %end_stream_out_1_copy, %"class.hls::stream.10"* %top_stream_out_2_copy, %"class.hls::stream.10"* %end_stream_out_2_copy, %"class.hls::stream.15"* %complete_stream_in_copy)
  call fastcc void @copy_out([32768 x i32]* %0, [32768 x i32]* %hash_table_pointer_copy, %"class.hls::stream"* %flame_stream_in, %"class.hls::stream"* nonnull align 512 %flame_stream_in_copy, %"class.hls::stream"* %flame_stream_out, %"class.hls::stream"* nonnull align 512 %flame_stream_out_copy, %"class.hls::stream.10"* %top_stream_out_1, %"class.hls::stream.10"* nonnull align 512 %top_stream_out_1_copy, %"class.hls::stream.10"* %end_stream_out_1, %"class.hls::stream.10"* nonnull align 512 %end_stream_out_1_copy, %"class.hls::stream.10"* %top_stream_out_2, %"class.hls::stream.10"* nonnull align 512 %top_stream_out_2_copy, %"class.hls::stream.10"* %end_stream_out_2, %"class.hls::stream.10"* nonnull align 512 %end_stream_out_2_copy, %"class.hls::stream.15"* %complete_stream_in, %"class.hls::stream.15"* nonnull align 512 %complete_stream_in_copy)
...
; Function Attrs: noinline
define internal fastcc void @copy_out([32768 x i32]*, [32768 x i32]* noalias readonly, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.10"*, %"class.hls::stream.10"* noalias align 512, %"class.hls::stream.10"*, %"class.hls::stream.10"* noalias align 512, %"class.hls::stream.10"*, %"class.hls::stream.10"* noalias align 512, %"class.hls::stream.10"*, %"class.hls::stream.10"* noalias align 512, %"class.hls::stream.15"*, %"class.hls::stream.15"* noalias align 512) unnamed_addr #6 {
entry:
...
declare void @apatb_hid_bound_set_1_hw(i32*, %"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream.10"*, %"class.hls::stream.10"*, %"class.hls::stream.10"*, %"class.hls::stream.10"*, %"class.hls::stream.15"*)

define void @hid_bound_set_1_hw_stub_wrapper(i32*, %"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream.10"*, %"class.hls::stream.10"*, %"class.hls::stream.10"*, %"class.hls::stream.10"*, %"class.hls::stream.15"*) #7 {
entry:
  %8 = bitcast i32* %0 to [32768 x i32]*
  call void @copy_out([32768 x i32]* null, [32768 x i32]* %8, %"class.hls::stream"* null, %"class.hls::stream"* %1, %"class.hls::stream"* null, %"class.hls::stream"* %2, %"class.hls::stream.10"* null, %"class.hls::stream.10"* %3, %"class.hls::stream.10"* null, %"class.hls::stream.10"* %4, %"class.hls::stream.10"* null, %"class.hls::stream.10"* %5, %"class.hls::stream.10"* null, %"class.hls::stream.10"* %6, %"class.hls::stream.15"* null, %"class.hls::stream.15"* %7)
  %9 = bitcast [32768 x i32]* %8 to i32*
  call void @hid_bound_set_1_hw_stub(i32* %9, %"class.hls::stream"* %1, %"class.hls::stream"* %2, %"class.hls::stream.10"* %3, %"class.hls::stream.10"* %4, %"class.hls::stream.10"* %5, %"class.hls::stream.10"* %6, %"class.hls::stream.15"* %7)
  call void @copy_in([32768 x i32]* null, [32768 x i32]* %8, %"class.hls::stream"* null, %"class.hls::stream"* %1, %"class.hls::stream"* null, %"class.hls::stream"* %2, %"class.hls::stream.10"* null, %"class.hls::stream.10"* %3, %"class.hls::stream.10"* null, %"class.hls::stream.10"* %4, %"class.hls::stream.10"* null, %"class.hls::stream.10"* %5, %"class.hls::stream.10"* null, %"class.hls::stream.10"* %6, %"class.hls::stream.15"* null, %"class.hls::stream.15"* %7)
  ret void
}

declare void @hid_bound_set_1_hw_stub(i32*, %"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream.10"*, %"class.hls::stream.10"*, %"class.hls::stream.10"*, %"class.hls::stream.10"*, %"class.hls::stream.15"*)
