; ModuleID = '/home/nomoto/src/StagedLSH/hard-StagedLSH/src/ver2.1/yan/u200/sw_emu/_x/hdis96_set_1/hdis96_set_1/hdis96_set_1/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_hdis96_set_1_ir(i1 %flag, %"class.hls::stream"* %complete_stream_in, %"class.hls::stream.0"* %top_stream_in, %"class.hls::stream.0"* %end_stream_in, %"class.hls::stream.8"* %flame96_stream_in1, %"class.hls::stream.8"* %flame96_stream_in2, %"class.hls::stream.0"* %count_stream_out, %"class.hls::stream.0"* %locate_stream_out) local_unnamed_addr #0 {
entry:
  ...
  %flame96_stream_in1_copy = alloca %"class.hls::stream.8", align 512
  %flame96_stream_in2_copy = alloca %"class.hls::stream.8", align 512
  %count_stream_out_copy = alloca %"class.hls::stream.0", align 512
  %locate_stream_out_copy = alloca %"class.hls::stream.0", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %complete_stream_in, %"class.hls::stream"* nonnull align 512 %complete_stream_in_copy, %"class.hls::stream.0"* %top_stream_in, %"class.hls::stream.0"* nonnull align 512 %top_stream_in_copy, %"class.hls::stream.0"* %end_stream_in, %"class.hls::stream.0"* nonnull align 512 %end_stream_in_copy, %"class.hls::stream.8"* %flame96_stream_in1, %"class.hls::stream.8"* nonnull align 512 %flame96_stream_in1_copy, %"class.hls::stream.8"* %flame96_stream_in2, %"class.hls::stream.8"* nonnull align 512 %flame96_stream_in2_copy, %"class.hls::stream.0"* %count_stream_out, %"class.hls::stream.0"* nonnull align 512 %count_stream_out_copy, %"class.hls::stream.0"* %locate_stream_out, %"class.hls::stream.0"* nonnull align 512 %locate_stream_out_copy)
  call void @apatb_hdis96_set_1_hw(i1 %flag, %"class.hls::stream"* %complete_stream_in_copy, %"class.hls::stream.0"* %top_stream_in_copy, %"class.hls::stream.0"* %end_stream_in_copy, %"class.hls::stream.8"* %flame96_stream_in1_copy, %"class.hls::stream.8"* %flame96_stream_in2_copy, %"class.hls::stream.0"* %count_stream_out_copy, %"class.hls::stream.0"* %locate_stream_out_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %complete_stream_in, %"class.hls::stream"* nonnull align 512 %complete_stream_in_copy, %"class.hls::stream.0"* %top_stream_in, %"class.hls::stream.0"* nonnull align 512 %top_stream_in_copy, %"class.hls::stream.0"* %end_stream_in, %"class.hls::stream.0"* nonnull align 512 %end_stream_in_copy, %"class.hls::stream.8"* %flame96_stream_in1, %"class.hls::stream.8"* nonnull align 512 %flame96_stream_in1_copy, %"class.hls::stream.8"* %flame96_stream_in2, %"class.hls::stream.8"* nonnull align 512 %flame96_stream_in2_copy, %"class.hls::stream.0"* %count_stream_out, %"class.hls::stream.0"* nonnull align 512 %count_stream_out_copy, %"class.hls::stream.0"* %locate_stream_out, %"class.hls::stream.0"* nonnull align 512 %locate_stream_out_copy)
  ret void
}
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ssdm_int.15(%struct.ssdm_int.15* noalias nocapture, %struct.ssdm_int.15* noalias nocapture) unnamed_addr #3 {
entry:
...
declare void @apatb_hdis96_set_1_hw(i1, %"class.hls::stream"*, %"class.hls::stream.0"*, %"class.hls::stream.0"*, %"class.hls::stream.8"*, %"class.hls::stream.8"*, %"class.hls::stream.0"*, %"class.hls::stream.0"*)

define void @hdis96_set_1_hw_stub_wrapper(i1, %"class.hls::stream"*, %"class.hls::stream.0"*, %"class.hls::stream.0"*, %"class.hls::stream.8"*, %"class.hls::stream.8"*, %"class.hls::stream.0"*, %"class.hls::stream.0"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %1, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %2, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %3, %"class.hls::stream.8"* null, %"class.hls::stream.8"* %4, %"class.hls::stream.8"* null, %"class.hls::stream.8"* %5, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %6, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %7)
  call void @hdis96_set_1_hw_stub(i1 %0, %"class.hls::stream"* %1, %"class.hls::stream.0"* %2, %"class.hls::stream.0"* %3, %"class.hls::stream.8"* %4, %"class.hls::stream.8"* %5, %"class.hls::stream.0"* %6, %"class.hls::stream.0"* %7)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %1, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %2, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %3, %"class.hls::stream.8"* null, %"class.hls::stream.8"* %4, %"class.hls::stream.8"* null, %"class.hls::stream.8"* %5, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %6, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %7)
  ret void
}

declare void @hdis96_set_1_hw_stub(i1, %"class.hls::stream"*, %"class.hls::stream.0"*, %"class.hls::stream.0"*, %"class.hls::stream.8"*, %"class.hls::stream.8"*, %"class.hls::stream.0"*, %"class.hls::stream.0"*)
